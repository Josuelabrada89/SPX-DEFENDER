...
PAPER_DAILY_LOSS_LIMIT = None  # 2026-09-02: sin bloqueo diario de pérdida en Paper por ahora
PAPER_AUTOTRADE_REFRESH_SECONDS = 3
PAPER_ALLOWED_STRATEGIES = {"PCS", "CCS"}

# Reglas ultra-conservadoras para Auto Trading REAL
REAL_TRADING_CAPITAL = 1000.0
REAL_TAKE_PROFIT_PER_TRADE = 50.0
REAL_STOP_LOSS_PER_TRADE = 100.0
REAL_DAILY_LOSS_LIMIT = 200.0
REAL_MAX_RISK_PER_TRADE = 500.0  # riesgo teórico máximo del spread; el SL operativo es -$100
REAL_SPREAD_WIDTH = 5.0
REAL_ALLOWED_STRATEGIES = {"PCS", "CCS"}
REAL_MIN_QUALITY_SCORE = 90.0
REAL_MAX_SHORT_DELTA = 0.10
REAL_MAX_SIMULTANEOUS_OPEN = 1
REAL_MAX_NEW_TRADES_PER_DAY = 2
REAL_CONTRACTS = 1
REAL_REQUIRE_PREVIEW = True
REAL_EXECUTION_ENABLED = True  # modo REAL habilitado; conserva preview y validaciones duras antes de cualquier envío

# Reglas selectivas para la prueba SIM / Ideas de Trade
AUTO_MIN_QUALITY_SCORE = 80.0
AUTO_MAX_NEW_TRADES_PER_DAY = 10
AUTO_IDEA_MAX_PER_DAY = 30
AUTO_IDEA_MAX_OPEN = 30
AUTO_IDEA_MAX_OPEN_PER_STRATEGY = 8
DAILY_PROFIT_LOCK_TRIGGER = 500.0
DAILY_PROFIT_LOCK_GIVEBACK = 200.0
IDEAS_DAILY_LOSS_LIMIT = None  # 2026-09-02: las Ideas no se apagan por P/L diario; MES necesita seguir recibiendo señales
AUTO_IDEA_BLOCKED_STRATEGIES = {"Iron Condor", "Iron Butterfly", "IC Box"}
AUTO_MAX_SIMULTANEOUS_OPEN = 5
AUTO_ENTRY_COOLDOWN_MINUTES = 3
...
# La fuente principal de datos SIEMPRE es Tradier Brokerage.
# Sandbox queda aislado exclusivamente para la ejecución automática Paper.
defender.BASE_URL = TRADIER_BROKERAGE_URL
...
AUTHORIZED_USERS = {
    ...
    "jj": "5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5",
    "luis": "5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5",
    "marian2026": "8bb0cf6eb9b17d0f7d22b456f121257dc1254e1f01665370476383ea776df414",
}
...
def require_tester_login():
    ...
    default_username = str(st.session_state.get("login_username_hint", "") or "")
    submitted = False
    username = default_username
    password = ""
    logo_data_uri = "data:image/webp;base64,"
    ...
    st.markdown(
        ...
        .stApp {
            background:
                radial-gradient(circle at 14% 18%, rgba(20, 111, 255, .18), transparent 27%),
                radial-gradient(circle at 68% 15%, rgba(0, 207, 220, .10), transparent 25%),
                radial-gradient(circle at 50% 105%, rgba(24, 114, 255, .15), transparent 35%),
                linear-gradient(135deg, #030812 0%, #06111e 48%, #030914 100%) !important;
            overflow-x: hidden;
        }
        .stApp::before {
            content: "";
            ...
            pointer-events: none;
            background-image:
                linear-gradient(rgba(70, 120, 180, .055) 1px, transparent 1px),
                linear-gradient(90deg, rgba(70, 120, 180, .055) 1px, transparent 1px);
        ...
        .stApp::after {
            content: "";
            position: fixed;
            left: -8%; right: -8%; bottom: -24%; height: 52%;
            pointer-events: none; opacity: .42;
            background:
                repeating-linear-gradient(165deg, transparent 0 28px, rgba(36, 132, 255, .11) 29px 30px),
                radial-gradient(ellipse at 50% 0%, rgba(24, 151, 255, .14), transparent 65%);
            transform: perspective(500px) rotateX(64deg);
        }
        [data-testid="stSidebar"] { display: none; }
        [data-testid="stHeader"] {
            background: rgba(3, 8, 18, .30);
            border-bottom: 1px solid rgba(71, 109, 151, .13);
        }
        [data-testid="stMainBlockContainer"] {
            max-width: 1420px;
            padding-top: 1.15rem;
        ...
        .brand-logo {
            ...
            margin-bottom: .65rem;
            filter: drop-shadow(0 16px 34px rgba(0, 102, 255, .17));
        }
        .brand-rule {
            width: 250px; height: 1px; margin: .1rem 0 1.2rem .1rem;
            background: linear-gradient(90deg, transparent, #29dbe1 38%, #368cff 70%, transparent);
            box-shadow: 0 0 16px rgba(39, 215, 230, .8);
        }
        .brand-kicker {
            color: #b9c8da; text-transform: uppercase; letter-spacing: .22em;
            font-size: .73rem; font-weight: 700; margin-bottom: .8rem;
        }
        .brand-headline {
            color: var(--login-text); font-size: clamp(2rem, 3vw, 3.55rem);
            line-height: 1.07; font-weight: 780; letter-spacing: -.035em; max-width: 720px;
        }
        .brand-headline span {
            background: linear-gradient(90deg, #25dfce, #4aa4ff);
            -webkit-background-clip: text; background-clip: text; color: transparent;
        }
        .brand-copy {
            color: #aab7c9; margin-top: 1rem; font-size: 1.02rem;
            line-height: 1.65; max-width: 680px;
        }
        .feature-row {
            display: grid; grid-template-columns: repeat(4, minmax(0,1fr));
            gap: .72rem; margin-top: 1.45rem; max-width: 800px;
        }
        .feature-card {
            min-height: 148px; padding: .95rem .82rem .82rem; border-radius: 16px;
            background: linear-gradient(180deg, rgba(11,25,43,.82), rgba(6,15,27,.78));
            border: 1px solid rgba(67, 121, 180, .34);
        ...
        .feature-icon {
            ...
            border: 1px solid rgba(42, 216, 225, .55);
            background: radial-gradient(circle at 35% 30%, rgba(41,224,209,.20), rgba(28,87,170,.10));
            color: #42ddd7; font-size: 1.15rem;
            box-shadow: 0 0 18px rgba(26, 144, 255, .12);
        }
        .feature-card strong { color: #edf5ff; font-size: .82rem; letter-spacing: .025em; }
        .feature-line { width: 30px; height: 2px; margin: .45rem 0; background: linear-gradient(90deg, #21d9ca, #3188ff); }
        .feature-card span { color: #8ea0b5; font-size: .73rem; line-height: 1.4; }
        .login-shell-title { text-align: center; margin: 0 0 .15rem; font-size: 2rem; font-weight: 800; color: var(--login-text); }
        .login-shell-subtitle { text-align: center; color: #aebbc9; margin: 0 0 .95rem; font-size: .98rem; }
        .login-lock {
            width: 68px; height: 68px; margin: .15rem auto 1rem; border-radius: 50%;
            display: flex; align-items: center; justify-content: center; font-size: 1.7rem;
            color: #59e9e0; border: 1px solid rgba(74, 173, 255, .65);
            background: radial-gradient(circle at 50% 35%, rgba(46, 208, 223, .15), rgba(9, 26, 43, .84));
            box-shadow: 0 0 0 8px rgba(42, 128, 255, .05), 0 0 26px rgba(45, 183, 255, .22);
        }
        .login-accent { width: 62px; height: 2px; margin: 0 auto 1.1rem; background: linear-gradient(90deg, #24e1ca, #2687ff); }
        div[data-testid="stForm"] {
            padding: 1.5rem 1.45rem 1.3rem !important;
            background: linear-gradient(180deg, rgba(8, 22, 39, .93), rgba(4, 13, 24, .96));
            border: 1px solid rgba(71, 158, 245, .58); border-radius: 27px;
            box-shadow: 0 30px 90px rgba(0,0,0,.45), 0 0 42px rgba(0,113,255,.13);
            backdrop-filter: blur(18px);
        }
        div[data-testid="stForm"]::before {
            content: ""; display: block; height: 2px; width: 52%; margin: -1.5rem auto 1.35rem;
            background: linear-gradient(90deg, transparent, rgba(55, 198, 255, .9), transparent);
            box-shadow: 0 0 14px rgba(37, 172, 255, .75);
        }
        div[data-testid="stForm"] label p, div[data-testid="stCheckbox"] label span {
            color: #e0e9f4 !important; font-weight: 650;
        }
        .stTextInput input {
            min-height: 3.25rem; border-radius: 14px !important;
            background: rgba(3, 11, 21, .86) !important;
            border: 1px solid rgba(103, 129, 158, .66) !important;
            color: #f4f8ff !important;
        }
        .stTextInput input:focus {
            border-color: rgba(44, 178, 255, .95) !important;
            box-shadow: 0 0 0 2px rgba(42, 159, 255, .14) !important;
        }
        .stTextInput input::placeholder { color: #71839a !important; }
        div[data-testid="stForm"] [data-testid="stFormSubmitButton"] button {
            min-height: 3.35rem; border-radius: 14px; font-weight: 820; letter-spacing: .025em;
            color: white; border: 1px solid rgba(65, 190, 255, .55);
            background: linear-gradient(100deg, #27d7ce 0%, #169ddf 46%, #1e68e8 100%);
            box-shadow: 0 15px 32px rgba(20, 113, 228, .26), inset 0 1px 0 rgba(255,255,255,.16);
        }
        div[data-testid="stForm"] [data-testid="stFormSubmitButton"] button:hover {
            filter: brightness(1.08); transform: translateY(-1px);
            box-shadow: 0 18px 38px rgba(20, 113, 228, .34);
        }
        .secure-note { text-align: center; color: #8294aa; font-size: .78rem; margin-top: .8rem; line-height: 1.5; }
        .secure-note strong { color: #b9cadc; }
        .login-mini-brand { text-align: center; color: #5ddfd6; font-size: .75rem; letter-spacing: .16em; text-transform: uppercase; margin-top: .65rem; }
        @media (max-width: 980px) {
            [data-testid="stMainBlockContainer"] { padding-left: 1rem; padding-right: 1rem; }
            .brand-panel { min-height: auto; padding-top: .2rem; }
...
""",
    ...
    left_column, right_column = st.columns([1.28, 0.92], gap="large")

    with left_column:
        st.markdown(
            f"""
            <div class="brand-panel">
                <img src="{logo_data_uri}" class="brand-logo" alt="SPX Defender logo" />
                <div class="brand-rule"></div>
                <div class="brand-kicker">Analiza · Simula · Automatiza</div>
                <div class="brand-headline">Plataforma profesional para <span>análisis, simulación y auto trading paper.</span></div>
                <div class="brand-copy">Acceso privado con datos LIVE para mercado, ideas, analizador y simulador. Sandbox permanece aislado para automatización paper y pruebas controladas.</div>
                <div class="feature-row">
                    <div class="feature-card"><div class="feature-icon">⌁</div><strong>DATOS LIVE</strong><div class="feature-line"></div><span>Datos de mercado en tiempo real para análisis y seguimiento.</span></div>
                    <div class="feature-card"><div class="feature-icon">⚙</div><strong>AUTO TRADING PAPER</strong><div class="feature-line"></div><span>Automatización en Sandbox con ejecución paper separada.</span></div>
                    <div class="feature-card"><div class="feature-icon">◉</div><strong>MULTIUSUARIO</strong><div class="feature-line"></div><span>Configuración independiente para cada usuario autorizado.</span></div>
                    <div class="feature-card"><div class="feature-icon">✓</div><strong>GESTIÓN SEGURA</strong><div class="feature-line"></div><span>Credenciales LIVE y Sandbox gestionadas de forma separada.</span></div>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
    ...
    with right_column:
        ...
        with st.form("tester_login_form", clear_on_submit=False):
            ...
            st.markdown('<div class="login-shell-title">Iniciar sesión</div>', unsafe_allow_html=True)
            st.markdown('<div class="login-shell-subtitle">Accede a tu panel privado</div>', unsafe_allow_html=True)
            st.markdown('<div class="login-accent"></div>', unsafe_allow_html=True)
            username = st.text_input("USUARIO", value=default_username, placeholder="Ingresa tu usuario").strip().lower()
            password = st.text_input("CONTRASEÑA", type="password", placeholder="Ingresa tu contraseña")
            remember_username = st.checkbox("Recordar usuario", value=True)
            submitted = st.form_submit_button("ENTRAR A SPX DEFENDER  →", use_container_width=True)
            st.markdown('<div class="secure-note"><strong>🛡 Acceso seguro</strong> &nbsp;·&nbsp; Configuración individual por usuario</div><div class="login-mini-brand">SPX Defender Private Access · BUILD JJ-DIRECT-0831</div>', unsafe_allow_html=True)

    if submitted:
        if remember_username:
            st.session_state["login_username_hint"] = username
        clean_password = str(password or "").strip()
        password_hash = __import__("hashlib").sha256(clean_password.encode("utf-8")).hexdigest()
        expected_hash = AUTHORIZED_USERS.get(username)
        hashed_valid = bool(expected_hash and password_hash == expected_hash)
        jj_direct_valid = (username == "jj" and clean_password == "12345")
        if hashed_valid or jj_direct_valid:
...
@st.cache_resource
def get_client():
    # Datos de mercado principales: siempre Brokerage/LIVE.
    # El token LIVE es independiente del Sandbox del Auto Trading.
    defender.BASE_URL = TRADIER_BROKERAGE_URL
    token = str(st.session_state.get("tradier_live_token") or "").strip()
    if not token:
        token = str(configured_application_value("TRADIER_LIVE_TOKEN", "") or "").strip()
    if not token:
        token = str(configured_application_value("TRADIER_TOKEN", "") or "").strip()
    if not token:
        token = defender.load_token()
    return defender.TradierClient(token)
...
def change_tradier_connection(base_url, token=None):
    # Por seguridad, la conexión principal de datos no puede cambiar a Sandbox.
    # Sandbox se usa únicamente en tradier_paper_request().
    if base_url != TRADIER_BROKERAGE_URL:
        raise RuntimeError("Sandbox solo está permitido para Auto Trading Paper.")
    if not str(token or "").strip():
        raise RuntimeError("Ingresa el API token de tu cuenta real de Tradier.")

    clear_data()
    get_client.clear()
    st.session_state["tradier_connection_base_url"] = TRADIER_BROKERAGE_URL
    st.session_state["tradier_connection_token"] = str(token).strip()
    st.session_state["tradier_live_token"] = str(token).strip()
    defender.BASE_URL = TRADIER_BROKERAGE_URL
    st.rerun()
...
class AutomaticIdeasDatabase:
    ...
    def _initialize_schema(self):
        ...
        self.execute(
            """
            CREATE TABLE IF NOT EXISTS mes_trade_history (
                id TEXT PRIMARY KEY,
        ...
        self.execute(
            "CREATE INDEX IF NOT EXISTS idx_mes_history_user_day "
            "ON mes_trade_history(username, trading_day, opened_at)"
        )
        self.execute(
            "CREATE INDEX IF NOT EXISTS idx_mes_history_active "
            "ON mes_trade_history(username, account, instrument, status)"
        )
        self.execute(
            """
            CREATE TABLE IF NOT EXISTS paper_user_credentials (
                username TEXT PRIMARY KEY,
                paper_token TEXT NOT NULL,
        ...
        self.execute(
            """
            CREATE TABLE IF NOT EXISTS live_user_credentials (
                username TEXT PRIMARY KEY,
        ...
        self.execute(
            """
            CREATE TABLE IF NOT EXISTS real_user_credentials (
                username TEXT PRIMARY KEY,
        ...
        self.execute(
            """
            CREATE TABLE IF NOT EXISTS automatic_idea_daily_risk (
                trading_day TEXT NOT NULL,
                symbol TEXT NOT NULL,
...
def automatic_scanner_settings(symbol, spot, expirations):
    ...
    return {
        ...
        "max_open_per_strategy": int(setting("auto_max_open_per_strategy", AUTO_IDEA_MAX_OPEN_PER_STRATEGY)),
        "minimum_quality_score": float(setting("auto_minimum_quality_score", AUTO_MIN_QUALITY_SCORE)),
        "max_new_trades_per_day": int(setting("auto_max_new_trades_per_day", AUTO_IDEA_MAX_PER_DAY)),
        "max_simultaneous_open": int(setting("auto_max_simultaneous_open", AUTO_IDEA_MAX_OPEN)),
...
def automatic_ideas_daily_total_pnl(trading_day, symbol):
    """P/L combinado de Ideas de Trade: realizado + flotante de ideas abiertas."""
    with AutomaticIdeasDatabase() as database:
        rows = database.query(
            "SELECT status, realized_pnl, current_pnl FROM automatic_trade_ideas "
            "WHERE trading_day = ? AND symbol = ?",
            (str(trading_day), str(symbol).upper()),
        )
    total = 0.0
    for row in rows:
        if str(row.get("status") or "").upper() == "CLOSED":
            total += float(row.get("realized_pnl") or 0)
        else:
            total += float(row.get("current_pnl") or 0)
    return round(total, 2)


def automatic_ideas_daily_risk_status(trading_day, symbol):
    """Ideas: mantiene seguimiento de P/L y profit-lock, sin stop diario por pérdida.

    Importante: no apagar la generación por pérdidas diarias, porque MES consume
    las nuevas señales PCS/CCS.
    """
    symbol = str(symbol).upper()
    trading_day = str(trading_day)
    total_pnl = automatic_ideas_daily_total_pnl(trading_day, symbol)
    now_text = market_time().isoformat(timespec="seconds")
    with AutomaticIdeasDatabase() as database:
        rows = database.query(
            "SELECT * FROM automatic_idea_daily_risk WHERE trading_day = ? AND symbol = ?",
            (trading_day, symbol),
        )
        state = rows[0] if rows else {}
        peak = max(float(state.get("peak_pnl") or 0), total_pnl)
        active = bool(int(state.get("profit_lock_active") or 0)) or total_pnl >= DAILY_PROFIT_LOCK_TRIGGER
        locked = bool(int(state.get("locked") or 0))
        reason = str(state.get("lock_reason") or "")
        if active and total_pnl <= peak - DAILY_PROFIT_LOCK_GIVEBACK:
            locked = True
            reason = f"PROFIT LOCK: retroceso de ${DAILY_PROFIT_LOCK_GIVEBACK:,.0f} desde máximo ${peak:,.2f}"
        database.execute(
            "INSERT INTO automatic_idea_daily_risk "
            "(trading_day, symbol, peak_pnl, profit_lock_active, locked, lock_reason, updated_at) "
            "VALUES (?, ?, ?, ?, ?, ?, ?) "
            "ON CONFLICT(trading_day, symbol) DO UPDATE SET "
            "peak_pnl = excluded.peak_pnl, profit_lock_active = excluded.profit_lock_active, "
            "locked = excluded.locked, lock_reason = excluded.lock_reason, updated_at = excluded.updated_at",
            (trading_day, symbol, peak, int(active), int(locked), reason or None, now_text),
        )
    return {
        "total_pnl": total_pnl,
        "peak": round(peak, 2),
...
def update_automatic_open_signals(symbol, current_spot=None, current_time=None):
    ...
    with AutomaticIdeasDatabase() as database:
        ...
        for signal in signals:
            ...
            raw_pnl = round((float(signal["entry_credit"]) - debit) * multiplier, 2)
            pnl = raw_pnl
            status = "OPEN"
            close_reason = None
            stop_limit = max(float(signal["stop_loss"] or 0.0), 0.0)
            profit_target = max(float(signal["target_profit"] or 0.0), 0.0)

            # Gestión de riesgo prioritaria: SL -> TP -> vencimiento.
            # Antes se evaluaba VENCIMIENTO primero y una idea podía terminar, por ejemplo,
            # en -$613 aunque su SL ya hubiera sido cruzado. Para Ideas de Trade el cierre
            # es simulado, así que registramos el P/L al límite definido, no una pérdida
            # posterior causada por el siguiente refresco o por llegar a expiración.
            if stop_limit > 0 and raw_pnl <= -stop_limit:
                status = "CLOSED"
                close_reason = "LÍMITE DE PÉRDIDA"
                pnl = round(-stop_limit, 2)
            elif profit_target > 0 and raw_pnl >= profit_target:
                status = "CLOSED"
...
def perform_automatic_scan(symbol, expirations, force=False):
    ...
    # Gestiona primero las ideas abiertas y luego aplica el bloqueo SOLO a nuevas entradas.
    ideas_risk = automatic_ideas_daily_risk_status(now.date().isoformat(), symbol)
    if ideas_risk.get("locked"):
        return {
            "state": f"IDEAS BLOQUEADAS · {ideas_risk.get('reason') or 'LÍMITE DIARIO'}",
            "created": 0,
            "updated": updated_count,
            "daily_pnl": ideas_risk.get("total_pnl"),
            "daily_peak": ideas_risk.get("peak"),
            "scanned_at": now.isoformat(timespec="seconds"),
        }
    ...
    for expiration in automatic_scan_expirations(expirations, settings):
        try:
            ...
            candidates = {
                ...
                # Iron Butterfly queda en histórico/análisis, pero bloqueado para NUEVAS Ideas
                # hasta rediseñar su lógica y validar nuevamente sus estadísticas.
                "Iron Butterfly": [],
            }
            with AutomaticIdeasDatabase() as database:
                counts = {
                ...
                for strategy, strategy_candidates in candidates.items():
                    if strategy in AUTO_IDEA_BLOCKED_STRATEGIES:
                        continue
                    scored = sorted(
                        (
...
def load_saved_live_credentials(username):
    ...
    try:
        with AutomaticIdeasDatabase() as database:
            rows = database.query(
                "SELECT live_token FROM live_user_credentials WHERE username = ?",
                (username,),
            )
        if rows:
            return str(rows[0].get("live_token") or "")
    except Exception:
        pass
    return ""


def save_live_credentials_for_user(username, token):
    username = str(username or "").strip().lower()
    token = str(token or "").strip()
    if not username or not token:
        raise RuntimeError("Usuario y API token LIVE son obligatorios.")
    now_text = market_time().isoformat(timespec="seconds")
    with AutomaticIdeasDatabase() as database:
        existing = database.query(
            "SELECT username FROM live_user_credentials WHERE username = ?",
            (username,),
        )
        if existing:
            database.execute(
                "UPDATE live_user_credentials SET live_token = ?, updated_at = ? WHERE username = ?",
                (token, now_text, username),
            )
        else:
            database.execute(
                "INSERT INTO live_user_credentials (username, live_token, updated_at) VALUES (?, ?, ?)",
                (username, token, now_text),
            )


def load_saved_real_credentials(username):
    username = str(username or "").strip().lower()
    if not username:
        return "", ""
    try:
        with AutomaticIdeasDatabase() as database:
            rows = database.query(
                "SELECT real_token, real_account_id FROM real_user_credentials WHERE username = ?",
                (username,),
            )
        if rows:
            return str(rows[0].get("real_token") or ""), str(rows[0].get("real_account_id") or "")
    except Exception:
        pass
    return "", ""


def save_real_credentials_for_user(username, token, account_id):
    username = str(username or "").strip().lower()
    token = str(token or "").strip()
    account_id = str(account_id or "").strip()
    if not username or not token or not account_id:
        raise RuntimeError("Usuario, API token REAL y Account ID son obligatorios.")
    # Validar antes de persistir. Una credencial equivocada jamás queda marcada como conectada.
    tradier_real_request("GET", f"/accounts/{account_id}/balances", token)
    now_text = market_time().isoformat(timespec="seconds")
    with AutomaticIdeasDatabase() as database:
        existing = database.query(
            "SELECT username FROM real_user_credentials WHERE username = ?",
            (username,),
        )
        if existing:
            database.execute(
                "UPDATE real_user_credentials SET real_token = ?, real_account_id = ?, updated_at = ? WHERE username = ?",
                (token, account_id, now_text, username),
            )
        else:
            database.execute(
                "INSERT INTO real_user_credentials (username, real_token, real_account_id, updated_at) VALUES (?, ?, ?, ?)",
                (username, token, account_id, now_text),
            )


def real_autotrading_credentials():
    token = str(st.session_state.get("tradier_real_token") or "").strip()
    account_id = str(st.session_state.get("tradier_real_account_id") or "").strip()
    return token, account_id


def tradier_real_request(method, path, token, payload=None):
    """Brokerage REAL: producción Tradier exclusivamente."""
    base_url = TRADIER_BROKERAGE_URL
    if base_url != "https://api.tradier.com/v1":
        raise RuntimeError("Bloqueo de seguridad: Auto Trading REAL debe usar Tradier Brokerage / LIVE.")
    url = f"{base_url}{path}"
    encoded = None
    headers = {
    ...
    try:
        ...
        try:
            ...
            detail = str(exc)
        raise RuntimeError(f"Tradier REAL HTTP {exc.code}: {detail[:500]}") from exc
    except urlerror.URLError as exc:
        raise RuntimeError(f"No se pudo conectar con Tradier REAL: {exc.reason}") from exc
    try:
        return json.loads(raw) if raw else {}
    except json.JSONDecodeError as exc:
        raise RuntimeError("Tradier REAL devolvió una respuesta que no es JSON.") from exc


def real_validate_candidate(signal):
    """Filtro duro. No envía órdenes; valida si una señal podría pasar a PREVIEW REAL."""
    reasons = []
    strategy = str(signal.get("strategy") or "")
    if strategy not in REAL_ALLOWED_STRATEGIES:
        reasons.append("REAL solo permite PCS, CCS o Iron Condor")
    try:
        short_strike = float(signal.get("short_strike"))
        long_strike = float(signal.get("long_strike"))
        width = abs(short_strike - long_strike)
    except Exception:
        width = 0.0
    if abs(width - REAL_SPREAD_WIDTH) > 0.001:
        reasons.append(f"ancho obligatorio: {REAL_SPREAD_WIDTH:.0f} puntos")
    contracts = int(signal.get("contracts") or 1)
    if contracts != REAL_CONTRACTS:
        reasons.append(f"REAL exige exactamente {REAL_CONTRACTS} contrato")
    credit = max(float(signal.get("entry_credit") or signal.get("credit") or 0), 0.0)
    max_risk = max((width - credit) * 100.0 * contracts, 0.0)
    if max_risk > REAL_MAX_RISK_PER_TRADE + 0.01:
        reasons.append(f"riesgo ${max_risk:,.0f} > máximo ${REAL_MAX_RISK_PER_TRADE:,.0f}")
    score = float(signal.get("score") or signal.get("quality_score") or 0.0)
    if score < REAL_MIN_QUALITY_SCORE:
        reasons.append(f"score {score:.1f} < {REAL_MIN_QUALITY_SCORE:.0f}")
    raw_delta = signal.get("delta")
    if raw_delta not in (None, ""):
        try:
            if abs(float(raw_delta)) > REAL_MAX_SHORT_DELTA + 1e-9:
                reasons.append(f"|delta| {abs(float(raw_delta)):.3f} > {REAL_MAX_SHORT_DELTA:.2f}")
        except Exception:
            reasons.append("delta inválida")
    else:
        reasons.append("sin delta confirmada para validar ≥90% estimado")
    return {
...
def load_saved_paper_credentials(username):
    username = str(username or "").strip().lower()
    if not username:
        return "", ""
    try:
        with AutomaticIdeasDatabase() as database:
            rows = database.query(
                "SELECT paper_token, paper_account_id FROM paper_user_credentials WHERE username = ?",
                (username,),
            )
        if rows:
            return str(rows[0].get("paper_token") or ""), str(rows[0].get("paper_account_id") or "")
    except Exception:
        pass
    return "", ""


def save_paper_credentials_for_user(username, token, account_id):
    username = str(username or "").strip().lower()
    token = str(token or "").strip()
    account_id = str(account_id or "").strip()
    if not username or not token or not account_id:
        raise RuntimeError("Usuario, API token y Paper Account ID son obligatorios.")
    now_text = market_time().isoformat(timespec="seconds")
    with AutomaticIdeasDatabase() as database:
        existing = database.query(
            "SELECT username FROM paper_user_credentials WHERE username = ?",
            (username,),
        )
        if existing:
            database.execute(
                "UPDATE paper_user_credentials SET paper_token = ?, paper_account_id = ?, updated_at = ? WHERE username = ?",
                (token, account_id, now_text, username),
            )
        else:
            database.execute(
                "INSERT INTO paper_user_credentials (username, paper_token, paper_account_id, updated_at) VALUES (?, ?, ?, ?)",
                (username, token, account_id, now_text),
            )


def paper_autotrading_credentials():
    # Cada usuario tiene sus propias credenciales Sandbox/Paper persistentes.
...
def paper_mark_connection_lost(error):
    """Marca una caída de conexión. La próxima conexión debe reconciliarse antes de abrir trades."""
    st.session_state["paper_connection_state"] = "CONEXIÓN PERDIDA"
    st.session_state["paper_needs_resync"] = True
    st.session_state["paper_last_connection_error"] = str(error)[:1000]
    st.session_state["paper_connection_lost_at"] = market_time().isoformat(timespec="seconds")


def paper_open_positions_snapshot(token, account_id):
    """Snapshot de posiciones Paper por símbolo OCC y cantidad para validar patas balanceadas."""
    response = tradier_paper_request("GET", f"/accounts/{account_id}/positions", token)
    positions = (response or {}).get("positions") or {}
    raw = positions.get("position") if isinstance(positions, dict) else positions
    if raw is None:
    ...
    for position in raw if isinstance(raw, list) else []:
        ...
        if abs(quantity) <= 0:
            continue
        symbols = _tradier_collect_option_symbols(position)
        for option_symbol in symbols:
            snapshot[str(option_symbol).upper()] = float(quantity)
    return snapshot


def paper_reconcile_autotrading(symbol, token, account_id):
    """Reconstruye el estado real desde Tradier antes de permitir nuevas entradas.

    La reconciliación es deliberadamente conservadora: cualquier spread FILLED que no pueda
    verificarse como estructura completa deja el motor bloqueado para nuevas entradas, pero
    no impide continuar consultando/gestionando las órdenes existentes.
    """
    st.session_state["paper_connection_state"] = "RECONECTANDO"

    # Estas dos lecturas validan la conexión y reconstruyen el estado real del broker.
    positions = paper_open_positions_snapshot(token, account_id)
    active_order_symbols = paper_active_order_symbols(token, account_id)
    st.session_state["paper_connection_state"] = "SINCRONIZANDO TRADIER"

    trading_day = market_time().date().isoformat()
    signals = list_automatic_signals(str(symbol).upper(), trading_day=trading_day, limit=500)
    signal_by_id = {str(item.get("id") or ""): item for item in signals}
    with AutomaticIdeasDatabase() as database:
        records = database.query(
            "SELECT * FROM paper_auto_orders WHERE trading_day = ? AND symbol = ? ORDER BY created_at ASC",
    ...
    for record in records:
        signal = signal_by_id.get(str(record.get("signal_id") or ""))
        if not signal:
            continue
        try:
            if record.get("entry_order_id"):
                details = paper_order_details(token, account_id, record.get("entry_order_id"))
                latest = str(details.get("status") or record.get("entry_status") or "").lower()
                fill = float(details.get("avg_fill_price") or 0)
                upsert_paper_order(
                    signal,
                    entry_status=latest or record.get("entry_status"),
                    entry_price=fill if fill > 0 else record.get("entry_price"),
                    last_error=None,
                )
                refreshed += 1
            record = paper_order_record(signal["id"]) or record
            if record.get("exit_order_id"):
                details = paper_order_details(token, account_id, record.get("exit_order_id"))
                latest = str(details.get("status") or record.get("exit_status") or "").lower()
                exit_fill = float(details.get("avg_fill_price") or 0)
                entry_fill = float(record.get("entry_price") or signal.get("entry_credit") or 0)
                contracts = int(signal.get("contracts") or 1)
                realized = record.get("realized_pnl")
                if latest == "filled" and exit_fill > 0 and entry_fill > 0:
                    realized = round(
                ...
                upsert_paper_order(
                    signal,
                    exit_status=latest or record.get("exit_status"),
            ...
            warnings.append(f"{signal.get('strategy')} · no se pudo refrescar una orden: {exc}")

    # Verifica que toda entrada FILLED todavía abierta conserve todas sus patas.
    with AutomaticIdeasDatabase() as database:
        current_records = database.query(
            "SELECT * FROM paper_auto_orders WHERE trading_day = ? AND symbol = ? ORDER BY created_at ASC",
            (trading_day, str(symbol).upper()),
        )
    for record in current_records:
        ...
        exit_status = str(record.get("exit_status") or "").lower()
        if entry_status != "filled" or exit_status in {"filled", "canceled", "cancelled", "rejected", "expired"}:
            continue
        try:
            expected = paper_signal_option_symbols(signal)
        except Exception as exc:
            warnings.append(f"{signal.get('strategy')} · no se pudieron reconstruir las patas: {exc}")
            continue
        present = set(positions).intersection(expected)
        working = set(active_order_symbols).intersection(expected)
        if present and present != expected:
            missing = sorted(expected - present)
            warnings.append(
                f"{signal.get('strategy')} · ESTRUCTURA NO BALANCEADA: faltan {', '.join(missing[:4])}"
            )
        elif not present and not working and not record.get("exit_order_id"):
            warnings.append(
                f"{signal.get('strategy')} · entrada FILLED no encontrada entre posiciones activas; revisión manual requerida."
            )

    verified_at = market_time().isoformat(timespec="seconds")
    st.session_state["paper_last_verified_at"] = verified_at
    st.session_state["paper_last_connection_error"] = ""
    if warnings:
        st.session_state["paper_connection_state"] = "BLOQUEADO · REVISAR"
        st.session_state["paper_needs_resync"] = True
        st.session_state["paper_reconcile_warnings"] = warnings
        return {
            "ok": False,
            "state": "BLOQUEADO · REVISAR",
            "warnings": warnings,
            "refreshed": refreshed,
            "verified_at": verified_at,
        }

    st.session_state["paper_connection_state"] = "VERIFICADO"
    st.session_state["paper_needs_resync"] = False
    st.session_state["paper_reconcile_warnings"] = []
    return {
        "ok": True,
        "state": "VERIFICADO",
        "warnings": [],
...
def paper_daily_total_pnl(trading_day, symbol):
    """P/L diario combinado: realizado + P/L flotante de posiciones Auto SIM abiertas."""
    realized = paper_daily_realized_pnl(trading_day)
    with AutomaticIdeasDatabase() as database:
        orders = database.query(
            "SELECT signal_id, entry_status, exit_status FROM paper_auto_orders "
            "WHERE trading_day = ? AND symbol = ?",
            (str(trading_day), str(symbol).upper()),
        )
        signals = database.query(
            "SELECT id, current_pnl FROM automatic_trade_ideas WHERE trading_day = ? AND symbol = ?",
            (str(trading_day), str(symbol).upper()),
        )
    pnl_by_signal = {str(row.get("id")): float(row.get("current_pnl") or 0) for row in signals}
    floating = 0.0
    terminal = {"filled", "canceled", "cancelled", "rejected", "expired"}
    for order in orders:
        if str(order.get("entry_status") or "").lower() != "filled":
            continue
        if str(order.get("exit_status") or "").lower() in terminal:
            continue
        floating += pnl_by_signal.get(str(order.get("signal_id") or ""), 0.0)
    return round(realized + floating, 2)


def paper_profit_lock_status(trading_day, symbol):
    """Activa +$500 y bloquea tras devolver $200 desde el máximo diario alcanzado."""
    total_pnl = paper_daily_total_pnl(trading_day, symbol)
    prefix = f"paper_profit_lock_{trading_day}_{str(symbol).upper()}"
    active_key = prefix + "_active"
    peak_key = prefix + "_peak"
    locked_key = prefix + "_locked"
    active = bool(st.session_state.get(active_key, False))
    peak = float(st.session_state.get(peak_key, total_pnl))
    locked = bool(st.session_state.get(locked_key, False))
    if total_pnl >= DAILY_PROFIT_LOCK_TRIGGER:
        active = True
    if active:
        peak = max(peak, total_pnl)
        if total_pnl <= peak - DAILY_PROFIT_LOCK_GIVEBACK:
            locked = True
    st.session_state[active_key] = active
    st.session_state[peak_key] = peak
    st.session_state[locked_key] = locked
    return {"active": active, "locked": locked, "peak": round(peak, 2), "total_pnl": total_pnl}
...
def process_paper_autotrading(symbol):
    ...
    if not bool(st.session_state.get("paper_autotrading_running", False)):
        st.session_state["paper_connection_state"] = "OFF"
        return {"state": "OFF", "opened": 0, "closed": 0}

    token, account_id = paper_autotrading_credentials()
    if not token or not account_id:
        st.session_state["paper_connection_state"] = "FALTA CONEXIÓN PAPER"
        st.session_state["paper_needs_resync"] = True
        return {"state": "FALTA CONEXIÓN PAPER", "opened": 0, "closed": 0}

    # Toda sesión nueva y toda recuperación de Internet/API debe reconciliarse primero.
    if "paper_needs_resync" not in st.session_state:
        st.session_state["paper_needs_resync"] = True
    if bool(st.session_state.get("paper_needs_resync")):
        reconciliation = paper_reconcile_autotrading(symbol, token, account_id)
        if not reconciliation.get("ok"):
            return {
                "state": reconciliation.get("state") or "BLOQUEADO · REVISAR",
                "opened": 0,
                "closed": 0,
                "warnings": reconciliation.get("warnings") or [],
                "daily_pnl": paper_daily_realized_pnl(market_time().date().isoformat()),
                "verified_at": reconciliation.get("verified_at"),
            }
        # Un ciclo completo queda reservado exclusivamente para sincronizar.
        # En el siguiente ciclo, ya VERIFICADO, se permiten nuevas entradas.
        return {
            "state": "VERIFICADO · LISTO",
            "opened": 0,
            "closed": 0,
            "daily_pnl": paper_daily_realized_pnl(market_time().date().isoformat()),
            "verified_at": reconciliation.get("verified_at"),
    ...
    # Gestión de riesgo tiene prioridad sobre generación de ideas/UI.
    # Refresca P/L y dispara TP/SL antes de evaluar cualquier entrada nueva.
    try:
        update_automatic_open_signals(symbol, current_time=now)
    except Exception as risk_refresh_error:
        st.session_state["paper_risk_refresh_error"] = str(risk_refresh_error)[:1000]

    daily_pnl = paper_daily_realized_pnl(trading_day)
    profit_lock = paper_profit_lock_status(trading_day, symbol)
    market_open = market_is_open(now)
    entry_window_open = automatic_entry_window_open(now)
    # 2026-09-02: Paper no se detiene por pérdida diaria.
    # La gestión de TP/SL por operación, noticias, validación y anti-duplicados siguen activas.
    daily_loss_locked = False
    daily_profit_locked = bool(profit_lock.get("locked"))

    if not market_open:
        st.session_state["paper_connection_state"] = "VERIFICADO · MERCADO CERRADO"
        return {
            "state": "MERCADO CERRADO · VERIFICADO",
            "opened": 0,
            "closed": 0,
            "daily_pnl": daily_pnl,
            "verified_at": st.session_state.get("paper_last_verified_at"),
        }

    opened = 0
    closed = 0

    # Si esta consulta falla, el llamador marcará CONEXIÓN PERDIDA y obligará a reconciliar.
    ...
    for signal in signals:
        ...
        try:
            # 1) SIEMPRE refresca órdenes ya enviadas, incluso si nuevas entradas están bloqueadas.
            ...
            # 2) Si ya existe una entrada FILLED y la señal pidió cierre, gestiona la salida
            #    aunque haya blackout, límite diario o la ventana de entradas esté cerrada.
            if record:
                entry_status = str(record.get("entry_status") or "").lower()
                exit_status = str(record.get("exit_status") or "").lower()
                forced_profit_lock = daily_profit_locked
                if (
                    (str(signal.get("status")) == "CLOSED" or forced_profit_lock)
                    and entry_status == "filled"
                    and not record.get("exit_order_id")
                    and exit_status not in {"filled", "pending", "open", "submitted", "closing"}
                ):
                    # Marcar CLOSING antes de tocar la API evita dobles cierres si hay timeout/rerun.
                    upsert_paper_order(
                        signal,
                        exit_status="closing",
                        last_error=("DAILY PROFIT LOCK" if forced_profit_lock else str(signal.get("close_reason") or "TP/SL")),
                    )
            ...
            # 3) A partir de aquí SOLO se evalúan entradas nuevas.
            if signal_time < cutoff or not entry_window_open or daily_loss_locked or daily_profit_locked:
                continue

            blackout, _event_time = high_impact_news_blackout(now)
            if blackout:
                continue
            ...
            successful_entries = [
                r for r in day_orders
                if str(r.get("entry_status") or "").lower() in {"filled", "open", "pending", "submitted", "verifying"}
            ]
            if len([r for r in day_orders if str(r.get("entry_status") or "").lower() == "filled"]) >= AUTO_MAX_NEW_TRADES_PER_DAY:
                break

            active_entries = [
                r for r in successful_entries
                if not r.get("exit_order_id")
                or str(r.get("exit_status") or "").lower() not in {"filled", "canceled", "cancelled", "rejected", "expired"}
            ]
            if len(active_entries) >= AUTO_MAX_SIMULTANEOUS_OPEN:
                continue

            # Seguridad: una orden pendiente/submitted/verifying/unknown bloquea TODAS las
            # entradas nuevas hasta reconciliar Tradier. Evita duplicados después de HTTP 500/timeouts.
            unresolved_entries = [
                r for r in day_orders
                if str(r.get("entry_status") or "").lower() in {"pending", "submitted", "verifying", "unknown", "open"}
                and not r.get("exit_order_id")
            ]
            ...
            if successful_entries:
                try:
                    last_time = datetime.fromisoformat(
                        str(successful_entries[0].get("updated_at") or successful_entries[0].get("created_at") or "")
                    )
            ...
            is_network_error = any(term in message for term in (
                "conectar", "timeout", "timed out", "network", "url",
                "http 401", "http 403", "http 429", "tradier paper http"
            ))
            if is_network_error:
                # Un HTTP 500/timeout deja el resultado incierto. Marcamos VERIFYING y
                # congelamos nuevas entradas hasta reconciliar órdenes/posiciones con Tradier.
                try:
                    signal_symbols, _ = paper_conflict_check(signal, occupied_symbols)
                    occupied_symbols.update(signal_symbols)
                except Exception:
                    pass
                upsert_paper_order(
                    signal,
                    entry_status="verifying",
                    last_error=str(exc)[:1000],
                )
                paper_mark_connection_lost(exc)
                break
            upsert_paper_order(signal, last_error=str(exc)[:1000])

    if daily_loss_locked:
        state = "GESTIÓN ACTIVA · ENTRADAS BLOQUEADAS"
    elif not entry_window_open:
        state = "GESTIÓN ACTIVA · ESPERANDO 9:35 AM"
    else:
        state = "AUTO PAPER ACTIVO · VERIFICADO"
    st.session_state["paper_connection_state"] = state
    st.session_state["paper_last_verified_at"] = market_time().isoformat(timespec="seconds")
...
def run_global_paper_autotrader(symbol):
    def paper_fragment():
        try:
            ...
            paper_mark_connection_lost(exc)
            st.session_state["paper_autotrading_result"] = {
                "state": "CONEXIÓN PERDIDA",
                "error": str(exc),
                "needs_resync": True,
                "daily_pnl": paper_daily_realized_pnl(market_time().date().isoformat()),
            }
...
def render_paper_autotrading_page(symbol):
    # Carga automáticamente las credenciales Paper guardadas para el usuario actual.
    current_user = str(st.session_state.get("defender_username") or "").strip().lower()
    loaded_for = str(st.session_state.get("paper_credentials_loaded_for") or "")
    if loaded_for != current_user:
        saved_token, saved_account = load_saved_paper_credentials(current_user)
        st.session_state["tradier_paper_token"] = saved_token
        st.session_state["tradier_paper_account_id"] = saved_account
        st.session_state["tradier_paper_token_input"] = saved_token
        st.session_state["tradier_paper_account_input"] = saved_account
        st.session_state["paper_credentials_loaded_for"] = current_user
    ...
    if "paper_needs_resync" not in st.session_state:
        st.session_state["paper_needs_resync"] = True
    if "paper_connection_state" not in st.session_state:
        st.session_state["paper_connection_state"] = "PENDIENTE DE VERIFICAR"

    st.title("🤖 Auto Trading SIM · Tradier Sandbox")
    st.caption(
    ...
    st.info(
        ...
        "Auto SIM opera únicamente PCS/CCS, siempre como spreads completos de 2 patas. Iron Condor, IB e IC Box quedan fuera del automático por ahora. "
    ...
    with st.expander("🔐 Conectar Tradier Paper", expanded=not bool(token_default and account_default)):
        ...
        if st.button("GUARDAR CONEXIÓN PAPER", use_container_width=True):
            try:
                save_paper_credentials_for_user(current_user, token, account_id)
                st.session_state["tradier_paper_token"] = token.strip()
                st.session_state["tradier_paper_account_id"] = account_id.strip()
                st.session_state["paper_needs_resync"] = True
                st.session_state["paper_connection_state"] = "RECONECTANDO"
                st.success(f"Conexión Paper guardada para {current_user}. Se cargará automáticamente al volver a entrar.")
                st.rerun()
            except Exception as error:
                st.error(f"No se pudo guardar la conexión Paper: {error}")

    saved_token, saved_account = paper_autotrading_credentials()
    c1, c2, c3 = st.columns(3)
    c1.metric("Data para señales", "LIVE · Tradier Brokerage")
    c2.metric("Ejecución", "PAPER" if saved_token and saved_account else "SIN CONECTAR")
    c3.metric("Pérdida máxima diaria", "SIN LÍMITE")
    ...
    st.caption("Sin límite diario de pérdida por ahora. El bot puede seguir buscando y ejecutando PCS/CCS durante la sesión; TP/SL por operación y las demás protecciones siguen activas.")
    st.caption("⏰ Las ideas nuevas y las órdenes automáticas comienzan a las 9:35 AM ET, cinco minutos después de la apertura.")
    st.caption(f"🎯 SIM selectivo: score ≥ {AUTO_MIN_QUALITY_SCORE:.0f} · hasta {AUTO_MAX_NEW_TRADES_PER_DAY} entradas/día · estrategias PCS/CCS/IC · hasta {AUTO_MAX_SIMULTANEOUS_OPEN} simultáneas · cooldown {AUTO_ENTRY_COOLDOWN_MINUTES} min. Ideas puede conservar hasta 30 oportunidades independientemente del Auto SIM.")
    ...
    st.subheader("Estado y recuperación")
    s1, s2, s3, s4 = st.columns(4)
    engine_state = str(result.get("state") or st.session_state.get("paper_connection_state") or ("ACTIVO" if enabled else "OFF"))
    s1.metric("Motor", engine_state)
    ...
    verified_at = str(result.get("verified_at") or st.session_state.get("paper_last_verified_at") or "")
    s4.metric("Última verificación", verified_at[11:19] if len(verified_at) >= 19 else "—")

    if engine_state == "CONEXIÓN PERDIDA":
        st.error("🔴 CONEXIÓN PERDIDA · No se abrirán operaciones nuevas. Al regresar la conexión, SPX Defender sincronizará primero posiciones y órdenes con Tradier.")
    elif engine_state in {"RECONECTANDO", "SINCRONIZANDO TRADIER"}:
        st.warning(f"🟠 {engine_state} · Entradas nuevas temporalmente bloqueadas.")
    elif "BLOQUEADO · REVISAR" in engine_state:
        st.error("🔴 La reconciliación encontró una discrepancia. El bot seguirá consultando el estado, pero NO abrirá nuevas operaciones hasta verificar la estructura.")
    elif "VERIFICADO" in engine_state or "ACTIVO" in engine_state:
        st.success("🟢 Tradier sincronizado · estado verificado. El automático puede continuar según sus filtros de entrada.")

    warnings = result.get("warnings") or st.session_state.get("paper_reconcile_warnings") or []
    for warning in warnings[:5]:
        st.warning(str(warning))
    if result.get("error"):
        st.error(str(result["error"]))

    with st.expander("🛡️ Qué pasa si se cae Internet", expanded=False):
        st.write(
            "El motor entra en CONEXIÓN PERDIDA y bloquea nuevas entradas. Cuando vuelve la conexión, "
            "pasa por RECONECTANDO → SINCRONIZANDO TRADIER → VERIFICADO. Antes de reanudar entradas "
            "consulta posiciones, órdenes, fills y patas de cada estrategia. Si detecta una estructura incompleta, "
            "queda BLOQUEADO · REVISAR en lugar de seguir operando a ciegas."
        )
        st.caption(
            "Las reglas de horario y noticias pueden bloquear entradas nuevas, pero no bloquean la revisión y gestión de operaciones ya abiertas. El P/L diario ya no apaga el motor de señales."
        )
    ...
    if enabled:
        st.success("🤖 Auto Trading SIM está encendido.")
        schedule_live_page_refresh("paper_autotrading", PAPER_AUTOTRADE_REFRESH_SECONDS)
    else:
        st.info("Auto Trading SIM está apagado. La generación normal de ideas continúa funcionando.")
...
def render_portfolio_robot(symbol, expirations):
    ...
    st.write(
        ...
        f"**{money(suggested_trade_risk)}** o menos. Auto Trading Paper está temporalmente **sin límite diario de pérdida**; el control se mantiene por operación."
    )
...
<section class="live-builder">
  <header class="live-header compact-header">
    <div><h2 id="live-title">Estrategia</h2></div>
    <div id="live-spot" class="live-spot"></div>
  </header>
  <div class="date-row">
    <div class="section-label">VENCIMIENTO</div>
    <div id="date-rail" class="date-rail"></div>
  </div>
  <div class="strike-heading">
    <div>
      <div class="section-label">STRIKES CERCANOS AL PRECIO</div>
      <div class="strike-subtitle">Centrados automáticamente en SPX · desliza hacia los lados para ver más</div>
    </div>
    <div class="strike-nav">
      <button id="strike-left" class="strike-nav-button" type="button">‹</button>
      <button id="strike-center" class="strike-center-button" type="button">CENTRAR</button>
      <button id="strike-right" class="strike-nav-button" type="button">›</button>
    </div>
  </div>
  <div id="strike-stage" class="strike-stage">
    <svg id="strike-rail" class="strike-rail" viewBox="0 0 920 146" preserveAspectRatio="none"></svg>
    <div id="strike-tooltip" class="strike-tooltip hidden"></div>
  </div>
  <div class="strike-help">Arrastra una pata para cambiar su strike · la vista permanece compacta y desplazable</div>
...
LIVE_BUILDER_CSS += """
.compact-header{margin-bottom:5px}.compact-header h2{margin:0;font-size:17px;font-weight:760}.date-row{display:grid;grid-template-columns:92px minmax(0,1fr);gap:10px;align-items:center}.date-row .section-label{margin:0}.date-rail{padding:3px 0 5px}.date-chip{min-width:62px;padding:6px 7px}.strike-heading{display:flex;align-items:flex-end;justify-content:space-between;gap:12px;margin-top:5px;margin-bottom:7px}.strike-heading .section-label{margin:0}.strike-subtitle{margin-top:3px;color:#8194ae;font-size:9px}.strike-nav{display:flex;align-items:center;gap:5px;flex-shrink:0}.strike-nav-button,.strike-center-button{height:27px;border:1px solid #344964;background:#111d2c;color:#bcd8f7;border-radius:7px;cursor:pointer;font-size:11px;font-weight:720}.strike-nav-button{width:30px;font-size:20px;line-height:20px}.strike-center-button{padding:0 9px;font-size:9px;letter-spacing:.05em}.strike-nav-button:hover,.strike-center-button:hover{background:#1b3048;border-color:#5f97cf;color:#f2f7ff}.strike-stage{position:relative;overflow-x:auto;overflow-y:hidden;border:1px solid #28364b;border-radius:10px;background:#0f1622;scrollbar-width:thin;scrollbar-color:#6485ad #111a27;scroll-behavior:smooth}.strike-stage .strike-rail{display:block;height:142px;width:auto;min-width:100%;border-radius:0;touch-action:none}.strike-marker{cursor:ew-resize}.strike-marker:active{cursor:grabbing}.strike-tooltip{position:absolute;pointer-events:none;top:8px;z-index:4;min-width:120px;padding:7px 9px;background:#17263a;border:1px solid #527298;border-radius:8px;color:#eef4fc;font-size:10px;line-height:1.4;box-shadow:0 7px 18px rgba(0,0,0,.24)}.strike-tooltip b{display:block;color:#7bc1ff;font-size:12px}.strike-help{margin-top:5px;color:#8295ae;font-size:9px;text-align:right}@media(max-width:680px){.date-row{grid-template-columns:1fr}.strike-heading{align-items:flex-start;flex-direction:column}.strike-nav{align-self:flex-end}.strike-help{text-align:left}}
"""
...
export default function(component) {
  ...
  const leftButton = byId("strike-left");
  const rightButton = byId("strike-right");
  const centerButton = byId("strike-center");
  let railDomain = [];
  let railWidth = 920;
  let centeredOnce = false;
  const centerStrikeRail = (smooth = true) => {
    const nearestIndex = railDomain.reduce((bestIndex, strike, index) =>
      Math.abs(strike - spot) < Math.abs(railDomain[bestIndex] - spot) ? index : bestIndex, 0);
    const usableWidth = Math.max(railWidth - 90, 1);
    const itemX = 45 + nearestIndex / Math.max(railDomain.length - 1, 1) * usableWidth;
    const target = Math.max(0, itemX - railStage.clientWidth / 2);
    railStage.scrollTo({ left: target, behavior: smooth ? "smooth" : "auto" });
  };
  const renderRail = () => {
    // Always keep the complete option strike set available horizontally.
    // The viewport itself stays compact and recenters near the live underlying price.
    railDomain = available.slice();
    ...
    // About 11-13 strikes are visible at once; additional strikes remain accessible by horizontal scroll.
    const pxPerStrike = window.innerWidth < 700 ? 64 : 70;
    railWidth = Math.max(920, 90 + railDomain.length * pxPerStrike);
    railSvg.style.width = railWidth + "px";
    railSvg.setAttribute("viewBox", "0 0 " + railWidth + " 146");
    const leftPad = 45, rightPad = 45;
    const usable = Math.max(railWidth - leftPad - rightPad, 1);
    const x = (strike) => leftPad + railDomain.indexOf(strike) / Math.max(railDomain.length - 1, 1) * usable;

    let highest = 1;
    railDomain.forEach((strike) => ["call", "put"].forEach((type) => { highest = Math.max(highest, Number((optionFor(type, strike) || {}).oi || 0)); }));
    const width = Math.max(4, Math.min(11, pxPerStrike * 0.18));
    let svg = '<line x1="' + leftPad + '" y1="68" x2="' + (railWidth-rightPad) + '" y2="68" stroke="#3b4a60" stroke-width="1"/>';
    railDomain.forEach((strike, index) => {
      const call = optionFor("call", strike) || {}, put = optionFor("put", strike) || {};
      const callHeight = Math.max(Math.sqrt(Number(call.oi || 0) / highest) * 43, 2);
      const putHeight = Math.max(Math.sqrt(Number(put.oi || 0) / highest) * 38, 2);
      const currentX = x(strike);
      svg += '<rect x="' + (currentX - width / 2).toFixed(1) + '" y="' + (68 - callHeight).toFixed(1) + '" width="' + width + '" height="' + callHeight.toFixed(1) + '" rx="2" fill="#1fc797" opacity=".68"/>';
      svg += '<rect x="' + (currentX - width / 2).toFixed(1) + '" y="69" width="' + width + '" height="' + putHeight.toFixed(1) + '" rx="2" fill="#ee5f73" opacity=".68"/>';
      svg += '<text x="' + currentX.toFixed(1) + '" y="133" fill="#b7c6da" font-size="10" font-weight="650" text-anchor="middle">' + priceFormat(strike).replace('.00','') + '</text>';
    });

    const nearestSpotStrike = railDomain.reduce((best, strike) => Math.abs(strike - spot) < Math.abs(best - spot) ? strike : best, railDomain[0]);
    const spotX = x(nearestSpotStrike);
    svg += '<line x1="' + spotX.toFixed(1) + '" x2="' + spotX.toFixed(1) + '" y1="5" y2="116" stroke="#69b4ff" stroke-width="1.4" stroke-dasharray="4 4"/>';
    svg += '<rect x="' + (spotX-28).toFixed(1) + '" y="5" width="56" height="16" rx="8" fill="#16324d" stroke="#3f79aa"/><text x="' + spotX.toFixed(1) + '" y="16" fill="#9cd0ff" font-size="8.5" font-weight="750" text-anchor="middle">SPX</text>';

    state.legs.forEach((leg, index) => {
      const currentX = x(leg.strike);
      const cy = leg.type === "call" ? 34 + (index % 2) * 12 : 101 - (index % 2) * 12;
      const fill = leg.type === "call" ? "#20d49d" : "#ff6b7e";
      svg += '<g data-leg="' + index + '" class="strike-marker"><circle cx="' + currentX.toFixed(1) + '" cy="' + cy + '" r="22" fill="transparent"/><circle class="marker-core" cx="' + currentX.toFixed(1) + '" cy="' + cy + '" r="13" fill="' + fill + '" stroke="#f2f6fb" stroke-width="2"/><text x="' + currentX.toFixed(1) + '" y="' + (cy + 4) + '" text-anchor="middle" fill="#0e1621" font-size="11" font-weight="800">' + (leg.action === "COMPRAR" ? "+" : "−") + '</text></g>';
    });
    railSvg.innerHTML = svg;
    if (!centeredOnce) {
      centeredOnce = true;
      requestAnimationFrame(() => centerStrikeRail(false));
    }
  };
  ...
  leftButton.onclick = () => railStage.scrollBy({ left: -Math.max(railStage.clientWidth * 0.72, 320), behavior: "smooth" });
  rightButton.onclick = () => railStage.scrollBy({ left: Math.max(railStage.clientWidth * 0.72, 320), behavior: "smooth" });
  centerButton.onclick = () => centerStrikeRail(true);
  ...
  railSvg.onpointermove = (event) => {
    ...
    const local = (event.clientX - rect.left) / Math.max(rect.width, 1) * railWidth;
    const indexFloat = (local - 45) / Math.max(railWidth - 90, 1) * Math.max(railDomain.length - 1, 1);
    const boundedIndex = Math.max(0, Math.min(railDomain.length - 1, indexFloat));
    const lowerIndex = Math.floor(boundedIndex), upperIndex = Math.ceil(boundedIndex);
    const lowerStrike = railDomain[lowerIndex], upperStrike = railDomain[upperIndex];
    const fraction = boundedIndex - lowerIndex;
    const desired = lowerStrike + (upperStrike - lowerStrike) * fraction;
    if (dragged === null) {
  ...
  railSvg.onpointerover = (event) => {
    ...
    if (core) core.setAttribute("r", "13");
  };
...
with st.sidebar:
    ...
    if st.button("Cerrar sesión", use_container_width=True):
        for key in ("defender_authenticated", "defender_username", "tradier_live_token", "tradier_live_token_input", "tradier_live_token_editor", "live_credentials_loaded_for", "tradier_paper_token", "tradier_paper_account_id", "tradier_paper_token_input", "tradier_paper_account_input", "paper_autotrading_running", "paper_autotrading_toggle", "paper_credentials_loaded_for"):
    ...
    st.divider()
    current_user = str(st.session_state.get("defender_username") or "").strip().lower()
    if st.session_state.get("live_credentials_loaded_for") != current_user:
        saved_live_token = load_saved_live_credentials(current_user)
        if saved_live_token:
            st.session_state["tradier_live_token"] = saved_live_token
            st.session_state["tradier_live_token_input"] = saved_live_token
        st.session_state["live_credentials_loaded_for"] = current_user

    with st.expander("⚡ Conexión de datos LIVE", expanded=not bool(st.session_state.get("tradier_live_token"))):
        st.success("Mercado, Ideas, Analizador y Simulador usan Tradier Brokerage / LIVE.")
        live_token_input = st.text_input(
            "Tradier LIVE API token",
            type="password",
            value=str(st.session_state.get("tradier_live_token_input") or st.session_state.get("tradier_live_token") or ""),
            key="tradier_live_token_editor",
            help="Usa aquí el token de producción/real de Tradier para datos de mercado. No uses el token Sandbox.",
        )
        if st.button("GUARDAR Y CONECTAR LIVE", use_container_width=True, key="save_live_connection"):
            try:
                save_live_credentials_for_user(current_user, live_token_input)
                st.session_state["tradier_live_token"] = live_token_input.strip()
                st.session_state["tradier_live_token_input"] = live_token_input.strip()
                clear_data()
                get_client.clear()
                st.success("Token LIVE guardado. Reconectando datos de mercado…")
                st.rerun()
            except Exception as error:
                st.error(str(error))
        if st.session_state.get("tradier_live_token"):
            st.caption("✅ LIVE conectado para este usuario.")
        else:
            st.warning("Introduce tu API token LIVE de Tradier para cargar datos de mercado.")
        st.caption("Sandbox queda separado y solo se usa para enviar órdenes automáticas Paper desde 🤖 Auto Trading SIM.")
    st.divider()


# -----------------------------------------------------------------------------
# MERCADO · LAYOUT MOCKUP PREMIUM (VISUAL ONLY)
# -----------------------------------------------------------------------------
st.markdown(
    """
    <style>
    .mk-shell{margin:.15rem 0 .9rem 0}
    .mk-titlebar{display:flex;align-items:flex-end;justify-content:space-between;gap:1rem;margin:.35rem 0 .85rem}
    .mk-kicker{font-size:.66rem;letter-spacing:.18em;text-transform:uppercase;color:#5aa9ff;font-weight:800}
    .mk-title{font-size:1.55rem;line-height:1.05;color:#f4f8ff;font-weight:850;margin-top:.25rem}
    .mk-sub{font-size:.76rem;color:#75879e;margin-top:.35rem}
    .mk-live{font-size:.67rem;letter-spacing:.08em;text-transform:uppercase;color:#8ce0c4;border:1px solid rgba(33,209,159,.25);background:rgba(33,209,159,.055);padding:.42rem .65rem;border-radius:999px;white-space:nowrap}
    .mk-metric-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:.55rem;margin:.2rem 0 .85rem}
    .mk-card{background:linear-gradient(180deg,rgba(17,27,42,.96),rgba(11,18,29,.97));border:1px solid rgba(64,86,116,.38);border-radius:12px;padding:.78rem .85rem;min-height:80px;box-shadow:0 8px 22px rgba(0,0,0,.12)}
    .mk-label{font-size:.63rem;letter-spacing:.08em;text-transform:uppercase;color:#71849c;font-weight:760}
    .mk-value{margin-top:.34rem;font-size:1.03rem;color:#f2f7ff;font-weight:820;line-height:1.05}
    .mk-note{margin-top:.28rem;font-size:.66rem;color:#73859c}
    .mk-accent-green{color:#47d7aa}.mk-accent-blue{color:#77b7ff}.mk-accent-orange{color:#ffbb69}
    .mk-section-label{display:flex;align-items:center;justify-content:space-between;margin:.2rem 0 .5rem}
    .mk-section-label strong{font-size:.72rem;letter-spacing:.11em;text-transform:uppercase;color:#b8c7d9}
    .mk-section-label span{font-size:.66rem;color:#6f8299}
    .mk-panel-head{font-size:.67rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:#98abc1;margin-bottom:.55rem}
    .mk-sentiment{display:flex;align-items:center;gap:.7rem;padding:.6rem .75rem;border-radius:10px;background:rgba(255,255,255,.025);border:1px solid rgba(64,86,116,.23);margin-bottom:.5rem}
    .mk-sentiment-dot{width:8px;height:8px;border-radius:50%;background:#21d19f;box-shadow:0 0 0 4px rgba(33,209,159,.11)}
    .mk-sentiment strong{color:#eef5ff;font-size:.78rem}.mk-sentiment span{color:#7c8fa6;font-size:.69rem}
    .mk-tickerbar{display:flex;gap:.45rem;overflow-x:auto;margin:.2rem 0 .7rem;padding-bottom:.1rem}
    .mk-ticker{min-width:150px;padding:.58rem .68rem;background:#0d1724;border:1px solid rgba(66,89,119,.33);border-radius:9px}
    .mk-ticker .sym{font-size:.68rem;color:#8aa0b8;font-weight:800}.mk-ticker .px{font-size:.84rem;color:#eef5ff;font-weight:800;margin-top:.15rem}
    @media(max-width:1100px){.mk-metric-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
    @media(max-width:700px){.mk-metric-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.mk-title{font-size:1.25rem}}
    </style>
    """,
    unsafe_allow_html=True,
)
...
# -----------------------------------------------------------------------------
# NAVEGACIÓN PRINCIPAL · ESTILO TERMINAL FINTECH
# Solo presentación: conserva exactamente los mismos valores de `page`.
# -----------------------------------------------------------------------------
st.markdown(
    """
    <style>
    /* ===== SPX DEFENDER · DASHBOARD PRO VISUAL LAYER ONLY ===== */
    :root{
        --dash-bg:#08101a;
        --dash-panel:#0f1825;
        --dash-panel-2:#121e2d;
    ...
    .stApp,[data-testid="stAppViewContainer"]{
        background:
            radial-gradient(circle at 12% -6%, rgba(46,117,230,.12), transparent 29%),
            radial-gradient(circle at 93% 8%, rgba(24,188,144,.07), transparent 25%),
            linear-gradient(180deg,#08101a 0%,#09111b 100%) !important;
    }
    [data-testid="stHeader"]{
        background:rgba(8,16,26,.88)!important;
        border-bottom:1px solid rgba(64,86,116,.18)!important;
    ...
    [data-testid="stSidebar"]{
        background:linear-gradient(180deg,#0b1420 0%,#09111a 100%)!important;
        border-right:1px solid #1d2b3e!important;
    }

    /* Brand/header similar to institutional options platform */
    .spx-pro-shell{
        border:1px solid rgba(65,88,119,.42);
        border-radius:14px;
        overflow:hidden;
    ...
    .spx-pro-top{
        ...
        justify-content:space-between;
        gap:1.25rem;
        border-bottom:1px solid rgba(62,84,113,.34);
        background:linear-gradient(180deg,rgba(18,29,44,.98),rgba(11,19,30,.98));
    }
    .spx-pro-brand{display:flex;align-items:center;gap:.8rem;min-width:0}
    .spx-pro-logo{
        width:39px;height:39px;border-radius:9px;display:grid;place-items:center;
        color:#9fd1ff;font-size:1.15rem;font-weight:900;
        background:linear-gradient(145deg,#17375d,#0c213c);
        border:1px solid rgba(80,161,255,.52);
        box-shadow:0 0 26px rgba(61,147,255,.14), inset 0 1px 0 rgba(255,255,255,.06);
    }
    .spx-pro-name{font-size:1.02rem;font-weight:850;letter-spacing:.095em;color:#f4f8ff;line-height:1}
    .spx-pro-tag{margin-top:.26rem;font-size:.64rem;letter-spacing:.17em;text-transform:uppercase;color:#71849d;font-weight:700}
    .spx-pro-status{display:flex;align-items:center;gap:.55rem;flex-wrap:wrap;justify-content:flex-end}
    .spx-status-chip{
        display:inline-flex;align-items:center;gap:.42rem;padding:.4rem .65rem;border-radius:7px;
        border:1px solid rgba(77,100,130,.36);background:rgba(255,255,255,.018);
        font-size:.67rem;font-weight:760;letter-spacing:.07em;color:#aab9cb;text-transform:uppercase;
    }
    .spx-status-chip.live{border-color:rgba(33,209,159,.28);color:#90e4ca;background:rgba(33,209,159,.055)}
    .spx-dot{width:6px;height:6px;border-radius:50%;background:#21d19f;box-shadow:0 0 0 3px rgba(33,209,159,.12)}
    .spx-pro-strip{
        display:flex;align-items:center;gap:1.1rem;padding:.48rem 1rem;
        background:#0a131f;color:#718299;font-size:.66rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;
        white-space:nowrap;overflow-x:auto;
    }
    .spx-pro-strip b{color:#c8d8e9;font-weight:760}
    .spx-pro-strip .positive{color:#46d8aa}

    /* Real horizontal navigation */
    div[data-testid="stMain"] div[data-testid="stRadio"] > label{display:none!important}
    div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"]{
        ...
        overflow-x:auto!important;padding:0 .22rem!important;margin:0 0 .85rem 0!important;
        border:1px solid rgba(66,89,119,.36)!important;border-radius:11px!important;
        background:linear-gradient(180deg,#101a28,#0c1521)!important;
        box-shadow:0 9px 28px rgba(0,0,0,.16)!important;
    }
    div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"] label{
        margin:0!important;padding:.76rem .84rem .68rem!important;min-height:46px!important;
        border:0!important;border-radius:0!important;background:transparent!important;
        border-right:1px solid rgba(57,77,103,.28)!important;cursor:pointer!important;position:relative!important;
        transition:background .16s ease!important;
    }
    div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"] label:hover{
        background:rgba(77,156,255,.055)!important;
    }
    div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"] label:has(input:checked){
        background:linear-gradient(180deg,rgba(47,112,207,.18),rgba(20,48,86,.14))!important;
        box-shadow:inset 0 -2px 0 var(--dash-blue)!important;
    }
    div[data-testid="stMain"] div[data-testid="stRadio"] [data-testid="stMarkdownContainer"] p{
        margin:0!important;color:#8899ae!important;font-size:.70rem!important;font-weight:780!important;
        letter-spacing:.035em!important;white-space:nowrap!important;
    }
    div[data-testid="stMain"] div[data-testid="stRadio"] label:has(input:checked) [data-testid="stMarkdownContainer"] p{
        color:#edf5ff!important;
    }
    div[data-testid="stMain"] div[data-testid="stRadio"] [data-baseweb="radio"]>div:first-child{display:none!important}

    /* Section hierarchy */
    h1{
        font-size:1.48rem!important;line-height:1.15!important;font-weight:820!important;
        letter-spacing:-.02em!important;color:#f2f7ff!important;margin-top:.55rem!important;margin-bottom:.8rem!important;
    }
    h2{font-size:1.10rem!important;font-weight:790!important;color:#e6eef9!important;letter-spacing:-.012em!important}
    h3{font-size:.95rem!important;font-weight:760!important;color:#dce7f5!important}
    p,label,[data-testid="stMarkdownContainer"]{font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important}
    [data-testid="stCaptionContainer"] p{color:#70839b!important;font-size:.73rem!important}

    /* Cards / metrics */
    [data-testid="stMetric"]{
        background:linear-gradient(180deg,rgba(17,28,43,.96),rgba(12,21,33,.98))!important;
        border:1px solid rgba(61,83,112,.42)!important;border-radius:10px!important;
        padding:.75rem .82rem!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.018)!important;
    }
    [data-testid="stMetricLabel"] p{font-size:.67rem!important;letter-spacing:.07em!important;text-transform:uppercase!important;color:#74869d!important;font-weight:760!important}
    [data-testid="stMetricValue"]{font-size:1.15rem!important;color:#eef5ff!important;font-weight:780!important;letter-spacing:-.02em!important}
    [data-testid="stMetricDelta"]{font-size:.72rem!important}
    [data-testid="stVerticalBlockBorderWrapper"]>div{
        background:linear-gradient(180deg,rgba(17,27,41,.94),rgba(12,20,31,.98))!important;
        border-color:rgba(60,81,109,.42)!important;border-radius:11px!important;
    }

    /* Inputs/buttons */
    .stButton>button,[data-testid="stFormSubmitButton"] button{
        border-radius:8px!important;min-height:2.45rem!important;font-size:.76rem!important;font-weight:760!important;
        letter-spacing:.02em!important;border:1px solid rgba(73,106,148,.44)!important;
        background:linear-gradient(180deg,#17263a,#111d2c)!important;color:#dce9f8!important;
        box-shadow:none!important;
    }
    .stButton>button:hover,[data-testid="stFormSubmitButton"] button:hover{
        border-color:rgba(77,156,255,.62)!important;background:linear-gradient(180deg,#1b3150,#13243a)!important;color:#fff!important;
    }
    div[data-baseweb="select"]>div,.stTextInput input,.stNumberInput input,.stTextArea textarea{
        background:#0c1622!important;border-color:#26384f!important;border-radius:8px!important;color:#e8f1fc!important;
    }
    [data-testid="stExpander"]{
        border:1px solid rgba(58,80,108,.38)!important;border-radius:9px!important;background:rgba(12,21,33,.72)!important;
    }
    [data-testid="stTabs"] [data-baseweb="tab-list"]{
        gap:.18rem!important;border-bottom:1px solid #233249!important;
    }
    [data-testid="stTabs"] button{
        color:#7f91a9!important;font-size:.72rem!important;font-weight:760!important;letter-spacing:.035em!important;
    }
    [data-testid="stTabs"] button[aria-selected="true"]{color:#eff6ff!important;border-bottom-color:#4d9cff!important}

    /* Dataframes and charts feel integrated */
    [data-testid="stDataFrame"],.stPlotlyChart,.stAltairChart{
        border-radius:10px!important;overflow:hidden!important;
        border:1px solid rgba(55,76,102,.28)!important;background:#0b1420!important;
    }

    @media(max-width:900px){
        [data-testid="stMainBlockContainer"]{padding-left:.65rem!important;padding-right:.65rem!important}
        .spx-pro-status{display:none}.spx-pro-name{font-size:.88rem}.spx-pro-strip{gap:.7rem}
        div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"] label{padding:.65rem .66rem .58rem!important}
    }
    </style>
    <div class="spx-pro-shell">
      <div class="spx-pro-top">
        <div class="spx-pro-brand">
          <div class="spx-pro-logo">◆</div>
          <div>
            <div class="spx-pro-name">SPX DEFENDER</div>
            <div class="spx-pro-tag">Options Intelligence</div>
          </div>
        </div>
        <div class="spx-pro-status">
          <div class="spx-status-chip live"><span class="spx-dot"></span> Tradier Live</div>
          <div class="spx-status-chip">Private Platform</div>
          <div class="spx-status-chip">DASHBOARD PRO · V2</div>
        </div>
      </div>
      <div class="spx-pro-strip">
        <span><b>SPX</b> · Options Analytics</span>
        <span>Live Market Data</span>
        <span>Strategy Builder</span>
        <span>Risk Engine</span>
        <span class="positive">● Systems Online</span>
      </div>
    </div>
    """,
    unsafe_allow_html=True,
...
st.markdown(
    """
    <style>
    /* SPX DEFENDER TERMINAL MARKET V3 */
    .terminal-market-header{margin:.15rem 0 .75rem 0;padding:.9rem 1.05rem;border:1px solid #1c2a3c;border-radius:14px;background:linear-gradient(180deg,#0b1420,#08111b);box-shadow:0 14px 40px rgba(0,0,0,.24)}
    .tm-brandline{display:flex;justify-content:space-between;align-items:center;gap:1rem}
    .tm-overline{font-size:.69rem;letter-spacing:.16em;color:#6f86a3;font-weight:800}
    .tm-symbol{font-size:1.22rem;line-height:1.2;color:#eef6ff;font-weight:850;margin-top:.2rem}.tm-symbol span{font-size:.72rem;color:#6f86a3;margin-left:.45rem;letter-spacing:.11em}
    .tm-live-badge{font-size:.72rem;color:#55e0ac;border:1px solid rgba(85,224,172,.25);background:rgba(85,224,172,.07);padding:.42rem .65rem;border-radius:999px;font-weight:800}
    .tm-tape{display:grid;grid-template-columns:repeat(8,minmax(0,1fr));gap:7px;margin:.35rem 0 .75rem}.tm-tape-card{background:#0d1723;border:1px solid #1e2c3f;border-radius:10px;padding:.68rem .72rem;min-width:0}.tm-tape-card.hero{background:linear-gradient(180deg,#102039,#0d1723);border-color:#29466c}.tm-tape-card span{display:block;font-size:.61rem;letter-spacing:.11em;color:#6f8199;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.tm-tape-card strong{display:block;color:#f3f8ff;font-size:1.03rem;margin:.28rem 0 .1rem;font-weight:840}.tm-tape-card.hero strong{color:#67b4ff;font-size:1.2rem}.tm-tape-card small{display:block;font-size:.57rem;color:#53657d;letter-spacing:.07em}
    .tm-sidepanel{background:linear-gradient(180deg,#0d1723,#0a131e);border:1px solid #1d2c40;border-radius:12px;padding:.78rem .82rem;margin-bottom:.7rem;box-shadow:0 10px 26px rgba(0,0,0,.16)}.tm-sidepanel.compact{padding:.7rem .78rem}.tm-panel-title{font-size:.64rem;letter-spacing:.13em;color:#7d90aa;font-weight:850;margin-bottom:.65rem;padding-bottom:.48rem;border-bottom:1px solid #1c293b}.tm-regime{font-size:.72rem;font-weight:850;padding:.48rem .55rem;border-radius:8px;margin-bottom:.65rem;text-align:center;letter-spacing:.06em}.tm-regime.positive{color:#49d9a5;background:rgba(73,217,165,.08);border:1px solid rgba(73,217,165,.18)}.tm-regime.negative{color:#ff7787;background:rgba(255,119,135,.08);border:1px solid rgba(255,119,135,.18)}.tm-regime.neutral{color:#86bfff;background:rgba(134,191,255,.08);border:1px solid rgba(134,191,255,.18)}
    .tm-row{display:flex;justify-content:space-between;align-items:center;gap:.6rem;padding:.35rem 0;color:#879ab2;font-size:.73rem}.tm-row b{color:#eaf2fc;font-size:.75rem}.tm-divider{height:1px;background:#1c293b;margin:.55rem 0}.tm-mini-title{font-size:.58rem;letter-spacing:.11em;color:#62758f;font-weight:800;margin-bottom:.4rem}.tm-range{display:flex;align-items:center;gap:.45rem;color:#dbe7f6;font-size:.69rem;font-weight:750}.tm-range i{height:4px;flex:1;border-radius:999px;background:linear-gradient(90deg,#ee6578,#4f9cff,#39d19d)}.tm-footnote{color:#52647b;font-size:.6rem;margin-top:.55rem;line-height:1.45}
    .tm-chart-shell{background:#09131d;border:1px solid #1d2c40;border-radius:12px;padding:.55rem .6rem .35rem;box-shadow:0 14px 34px rgba(0,0,0,.2)}.tm-chart-head{display:flex;justify-content:space-between;align-items:center;padding:.25rem .2rem .55rem;border-bottom:1px solid #172538;margin-bottom:.25rem}.tm-chart-head span{font-size:.68rem;letter-spacing:.13em;color:#8194ad;font-weight:850}.tm-chart-head b{font-size:.62rem;color:#4bdea8;letter-spacing:.1em}.tm-live-line{font-size:.63rem;color:#4bdea8;padding:.25rem .15rem .1rem}
    .tm-level{display:flex;justify-content:space-between;align-items:center;padding:.48rem .52rem;border-radius:8px;background:#0a1420;border:1px solid #182638;margin-bottom:.42rem}.tm-level span{font-size:.61rem;color:#70839b;letter-spacing:.08em;font-weight:800}.tm-level b{font-size:.81rem;color:#eef5ff}.tm-level.put b{color:#55d6aa}.tm-level.call b{color:#ff7787}.tm-level.mvs b{color:#ffb45f}.tm-status-row{display:grid;grid-template-columns:10px 1fr auto;align-items:center;gap:.4rem;padding:.34rem 0;font-size:.68rem}.tm-status-row .dot{width:7px;height:7px;border-radius:50%;background:#42d8a2;box-shadow:0 0 0 3px rgba(66,216,162,.1)}.tm-status-row b{color:#cad7e6}.tm-status-row em{font-style:normal;color:#42d8a2;font-size:.58rem;font-weight:800;letter-spacing:.08em}
    @media(max-width:1200px){.tm-tape{grid-template-columns:repeat(4,1fr)}}@media(max-width:760px){.tm-tape{grid-template-columns:repeat(2,1fr)}.tm-symbol span{display:none}}
    </style>
    """,
    unsafe_allow_html=True,
)
...
# -----------------------------------------------------------------------------
# VISUAL SHELL PRO · reconstrucción estética completa (sin tocar la lógica)
# -----------------------------------------------------------------------------
st.markdown(
    """
    <style>
    ...
    [data-testid="stMainBlockContainer"]{max-width:1600px!important;padding:1.0rem 1.35rem 2.5rem!important;}
    .spx-pro-top{background:linear-gradient(180deg,rgba(12,23,37,.98),rgba(8,17,28,.98));border:1px solid #1e334a;border-radius:14px 14px 10px 10px;padding:.85rem 1rem .72rem;margin:0 0 .55rem;box-shadow:0 18px 46px rgba(0,0,0,.28)}
    .spx-pro-topline{display:flex;align-items:center;justify-content:space-between;gap:1rem}.spx-pro-brand{display:flex;align-items:center;gap:.78rem}.spx-pro-mark{width:38px;height:38px;border-radius:10px;border:1px solid rgba(70,143,255,.48);background:linear-gradient(145deg,#102b48,#0b1d31);display:flex;align-items:center;justify-content:center;color:#71b3ff;font-size:1.15rem;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)}
    .spx-pro-name{font-size:1.02rem;font-weight:900;letter-spacing:.055em;color:#f1f6fd}.spx-pro-sub{font-size:.58rem;letter-spacing:.18em;text-transform:uppercase;color:#6f839c;margin-top:.12rem}.spx-pro-status{display:flex;align-items:center;gap:.8rem;color:#93a5ba;font-size:.67rem}.spx-pro-live{display:inline-flex;align-items:center;gap:.38rem;color:#4be0aa;font-weight:800;letter-spacing:.08em}.spx-pro-live:before{content:"";width:7px;height:7px;border-radius:50%;background:#42d9a5;box-shadow:0 0 0 4px rgba(66,217,165,.12)}.spx-pro-user{padding:.35rem .6rem;border:1px solid #24384f;border-radius:8px;background:#0b1724;color:#c8d6e6}
    div[data-testid="stMain"] div[data-testid="stRadio"]{margin:0 0 .7rem!important}div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"]{display:flex!important;gap:.18rem!important;overflow-x:auto!important;padding:.28rem!important;background:#091521!important;border:1px solid #1d3148!important;border-radius:10px!important;box-shadow:0 10px 28px rgba(0,0,0,.16)!important}div[data-testid="stMain"] div[data-testid="stRadio"] label{min-width:max-content!important;padding:.48rem .72rem!important;border-radius:7px!important;border:1px solid transparent!important;background:transparent!important;color:#8093aa!important;font-size:.68rem!important;font-weight:800!important;letter-spacing:.06em!important;text-transform:uppercase!important}div[data-testid="stMain"] div[data-testid="stRadio"] label:has(input:checked){background:linear-gradient(180deg,#16304b,#10253b)!important;color:#eef6ff!important;border-color:#2f5880!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)!important}div[data-testid="stMain"] div[data-testid="stRadio"] label p{color:inherit!important;font-size:inherit!important;font-weight:inherit!important}
    div[data-testid="stExpander"] details{border:1px solid #1e3147!important;border-radius:10px!important;background:#0a1622!important}.spx-config-note{font-size:.67rem;color:#73869e;margin:.15rem 0 .2rem}
    button[kind="secondary"] p{font-weight:800;}
    </style>
    """,
    unsafe_allow_html=True,
)
...
st.markdown(
    f'''<div class="spx-pro-top"><div class="spx-pro-topline"><div class="spx-pro-brand"><div class="spx-pro-mark">◆</div><div><div class="spx-pro-name">SPX DEFENDER</div><div class="spx-pro-sub">Options Intelligence Platform</div></div></div><div class="spx-pro-status"><span>{escape(selected_symbol())}</span><span class="spx-pro-live">TRADIER LIVE</span><span class="spx-pro-user">{escape(str(st.session_state.get("defender_username") or "USER").upper())}</span></div></div></div>''',
    unsafe_allow_html=True,
)

with st.expander("⚙ CONFIGURACIÓN / CONEXIONES", expanded=False):
    cfg_a, cfg_b, cfg_c = st.columns([1.15, 1.65, .8])
    visual_symbol = cfg_a.text_input("Símbolo", value=selected_symbol(), key="pro_symbol_search", placeholder="SPX, SPY, QQQ, AAPL…").strip().upper()
    visual_token = cfg_b.text_input("Tradier LIVE API token", type="password", value=str(st.session_state.get("tradier_live_token") or ""), key="pro_live_token")
    if cfg_c.button("APLICAR", use_container_width=True, key="pro_apply_settings"):
        try:
            if visual_symbol and re.fullmatch(r"[A-Z0-9./^_-]{1,16}", visual_symbol):
                st.session_state["active_symbol"] = visual_symbol
            if visual_token.strip():
                current_user = str(st.session_state.get("defender_username") or "").strip().lower()
                save_live_credentials_for_user(current_user, visual_token.strip())
                st.session_state["tradier_live_token"] = visual_token.strip()
                st.session_state["tradier_live_token_input"] = visual_token.strip()
            clear_data(); get_client.clear(); st.rerun()
        except Exception as error:
            st.error(str(error))
    st.markdown('<div class="spx-config-note">Datos LIVE y símbolo principal. Sandbox sigue separado para Auto Trading SIM.</div>', unsafe_allow_html=True)
    logout_col, refresh_col, _ = st.columns([.65,.75,2.6])
    if refresh_col.button("↻ ACTUALIZAR", use_container_width=True, key="pro_refresh_all"):
        clear_data(); st.rerun()
    if logout_col.button("SALIR", use_container_width=True, key="pro_logout"):
        for key in ("defender_authenticated", "defender_username", "tradier_live_token", "tradier_live_token_input", "tradier_live_token_editor", "live_credentials_loaded_for", "tradier_paper_token", "tradier_paper_account_id", "tradier_paper_token_input", "tradier_paper_account_input", "paper_autotrading_running", "paper_autotrading_toggle", "paper_credentials_loaded_for"):
            st.session_state.pop(key, None)
        st.rerun()
...
def _mes_bridge_request(method, bridge_url, bridge_key, path, payload=None, timeout=3.0):
    base = str(bridge_url or "").strip().rstrip("/")
    key = str(bridge_key or "").strip()
    if not base:
        raise RuntimeError("Escribe el Bridge URL.")
    if not key:
        raise RuntimeError("Escribe el Bridge Key.")
    ...
    req = urlrequest.Request(url, data=data, headers=headers, method=str(method).upper())
    try:
        with urlrequest.urlopen(req, timeout=float(timeout)) as response:
            raw = response.read().decode("utf-8", errors="replace")
    except urlerror.HTTPError as exc:
        body = exc.read().decode("utf-8", errors="replace") if exc.fp else ""
        raise RuntimeError(f"Bridge HTTP {exc.code}: {body or exc.reason}") from exc
    except Exception as exc:
        raise RuntimeError(f"No se pudo conectar al Bridge MES: {exc}") from exc
    try:
        return json.loads(raw) if raw else {}
    except Exception:
        return {"raw": raw}
...
def _mes_signal_created_at(signal):
    raw = str(signal.get("created_at") or signal.get("updated_at") or "")
    try:
        value = datetime.fromisoformat(raw)
        if value.tzinfo is None:
            value = value.replace(tzinfo=market_time().tzinfo)
        return value
    except Exception:
        return market_time().replace(hour=0, minute=0, second=0, microsecond=0)


def _best_mes_futures_signal(min_score=90.0):
    """Mejor señal abierta PCS/CCS de hoy para traducir a MES.

    MES no hereda límites diarios de pérdida de Tradier Paper. Solo requiere una
    señal PCS/CCS válida, score mínimo, horario permitido y cuenta Ninja FLAT.
    """
    now = market_time()
    rows = list_automatic_signals(
        "SPX", trading_day=now.date().isoformat(), status="OPEN", limit=200
    )
    candidates = []
    for row in rows:
        ...
        if strategy not in {"PCS", "CCS"}:
            continue
        score = float(defender.number(row.get("score")) or 0.0)
        if score < float(min_score):
            continue
        created = _mes_signal_created_at(row)
    ...
    if not candidates:
        return None
    candidates.sort(key=lambda r: (r["_score"], r["_created"]), reverse=True)
    return candidates[0]


def _mes_position_is_flat(payload):
    payload = payload or {}
    position = payload.get("position") or {}
    status = str(position.get("status", payload.get("status", "")) or "").strip().upper()
    return status in {"", "FLAT", "NONE", "0"} and not bool(payload.get("working_orders"))




# Historial persistente de Futuros MES.
# Se guarda en la misma base persistente de SPX Defender para sobrevivir cambios
# de pestaña, recargas y reinicios de Streamlit.
def _mes_history_username():
    return str(st.session_state.get("defender_username") or "local").strip().lower() or "local"


def _mes_find_number(payload, candidate_keys):
    """Busca un número por nombre exacto de campo en respuestas del Bridge."""
        ...
        if isinstance(item, dict):
            for key, value in item.items():
                if str(key).lower() in wanted:
                    number = defender.number(value)
                    if value is not None and math.isfinite(float(number)):
                        # defender.number devuelve 0 para algunos valores inválidos; 0 sí es válido para P/L.
                        try:
                            return float(value)
                        except Exception:
                            try:
...
def _mes_find_text(payload, candidate_keys):
    wanted = {str(key).lower() for key in candidate_keys}
    stack = [payload]
    while stack:
        item = stack.pop()
...
def _mes_position_snapshot(payload):
    payload = payload or {}
    position = payload.get("position") or {}
    status = str(position.get("status", payload.get("status", "")) or "").strip().upper()
    return {
        "status": status,
        "entry_price": _mes_find_number(payload, ["entry_price", "average_price", "avg_price", "average_fill_price"]),
        "exit_price": _mes_find_number(payload, ["exit_price", "close_price", "closing_price", "last_exit_price", "exit_fill_price"]),
        "unrealized_pnl": _mes_find_number(payload, ["unrealized_pnl", "unrealized_profit_loss", "open_pnl", "pnl"]),
        "realized_pnl": _mes_find_number(payload, ["realized_pnl", "realized_profit_loss", "closed_pnl", "last_realized_pnl"]),
        "close_reason": _mes_find_text(payload, ["close_reason", "exit_reason", "reason", "last_close_reason"]),
    }


def _mes_history_open_trade(account, instrument, direction, quantity, tp, sl,
                            source="AUTO", signal_id=None, strategy=None, score=None,
                            client_order_id=None, bridge_result=None):
    now = market_time()
    trade_id = str(uuid.uuid4())
    snap = _mes_position_snapshot(bridge_result or {})
    entry_price = snap.get("entry_price")
    with AutomaticIdeasDatabase() as database:
        database.execute(
            "INSERT INTO mes_trade_history "
            "(id, username, account, instrument, trading_day, source, signal_id, strategy, score, direction, quantity, "
            "opened_at, closed_at, entry_price, exit_price, take_profit, stop_loss, realized_pnl, close_reason, pnl_source, "
            "status, client_order_id, last_updated_at) "
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
            (
                trade_id, _mes_history_username(), str(account), str(instrument), now.date().isoformat(),
                str(source).upper(), signal_id, strategy, float(score) if score is not None else None,
                str(direction).upper(), int(quantity), now.isoformat(timespec="seconds"), None,
                entry_price, None, float(tp), float(sl), None, None, None, "OPEN",
                client_order_id, now.isoformat(timespec="seconds"),
            ),
        )
    st.session_state["mes_active_history_id"] = trade_id
    return trade_id


def _mes_history_active_trade(account, instrument):
    username = _mes_history_username()
    with AutomaticIdeasDatabase() as database:
        rows = database.query(
            "SELECT * FROM mes_trade_history WHERE username = ? AND account = ? AND instrument = ? "
            "AND status = 'OPEN' ORDER BY opened_at DESC",
            (username, str(account), str(instrument)),
        )
    return rows[0] if rows else None


def _mes_history_sync(account, instrument, bridge_payload):
    """Actualiza entrada/salida y cierra el registro cuando NinjaTrader vuelve a FLAT."""
    trade = _mes_history_active_trade(account, instrument)
    if not trade:
        return
    now = market_time()
    snap = _mes_position_snapshot(bridge_payload)
    is_flat = _mes_position_is_flat(bridge_payload)
    ...
    if not is_flat:
        st.session_state["mes_last_live_history"] = {
            "id": trade["id"],
        ...
        with AutomaticIdeasDatabase() as database:
            database.execute(
                "UPDATE mes_trade_history SET entry_price = ?, last_updated_at = ? WHERE id = ?",
                (entry_price, now.isoformat(timespec="seconds"), trade["id"]),
            )
        return

    # La posición ya está FLAT: capturar el cierre real si el Bridge lo expone.
    exit_price = snap.get("exit_price")
    realized = snap.get("realized_pnl")
    pnl_source = "BRIDGE" if realized is not None else None
    close_reason = str(snap.get("close_reason") or "").strip().upper()

    cached = st.session_state.get("mes_last_live_history") or {}
    previous_pnl = cached.get("unrealized_pnl") if cached.get("id") == trade.get("id") else None
    if realized is None and entry_price is not None and exit_price is not None:
        points = (float(exit_price) - float(entry_price))
        if str(trade.get("direction") or "").upper() == "SHORT":
            points *= -1
        realized = round(points * 5.0 * int(trade.get("quantity") or 1), 2)
        pnl_source = "CALCULADO_POR_PRECIOS"

    tp = float(trade.get("take_profit") or 0.0)
    sl = float(trade.get("stop_loss") or 0.0)
    if not close_reason:
        basis = realized if realized is not None else previous_pnl
        if basis is not None and tp > 0 and float(basis) >= tp * 0.80:
            close_reason = "TP"
        elif basis is not None and sl > 0 and float(basis) <= -sl * 0.80:
            close_reason = "SL"
        else:
            close_reason = "CERRADA"

    # Si el Bridge no devuelve P/L al quedar FLAT, conserva un valor coherente con
    # el OCO configurado cuando el último P/L observado ya estaba en TP/SL.
    if realized is None and previous_pnl is not None:
        if close_reason == "TP" and tp > 0:
            realized = round(tp, 2)
            pnl_source = "TP_CONFIGURADO"
        elif close_reason == "SL" and sl > 0:
            realized = round(-sl, 2)
            pnl_source = "SL_CONFIGURADO"
        else:
            realized = round(float(previous_pnl), 2)
            pnl_source = "ULTIMO_PNL_OBSERVADO"

    with AutomaticIdeasDatabase() as database:
        database.execute(
            "UPDATE mes_trade_history SET closed_at = ?, entry_price = ?, exit_price = ?, realized_pnl = ?, "
            "close_reason = ?, pnl_source = ?, status = 'CLOSED', last_updated_at = ? WHERE id = ?",
            (
                now.isoformat(timespec="seconds"), entry_price, exit_price, realized,
                close_reason, pnl_source, now.isoformat(timespec="seconds"), trade["id"],
            ),
        )
    st.session_state.pop("mes_active_history_id", None)
    st.session_state.pop("mes_last_live_history", None)


def _mes_history_rows(trading_day=None):
    username = _mes_history_username()
    day = str(trading_day or market_time().date().isoformat())
    with AutomaticIdeasDatabase() as database:
        return database.query(
            "SELECT * FROM mes_trade_history WHERE username = ? AND trading_day = ? ORDER BY opened_at DESC",
            (username, day),
        )


def render_mes_trade_history():
    st.divider()
    st.subheader("📒 Historial diario · Futuros MES")
    selected_day = st.date_input("Día", value=market_time().date(), key="mes_history_day")
    rows = _mes_history_rows(selected_day.isoformat())
    closed = [row for row in rows if str(row.get("status") or "").upper() == "CLOSED"]
    realized_values = [float(row["realized_pnl"]) for row in closed if row.get("realized_pnl") is not None]
    ...
    c1.metric("Trades cerrados", len(closed))
    c2.metric("Ganancias totales", f"${gross_wins:,.2f}")
    c3.metric("Pérdidas totales", f"-${abs(gross_losses):,.2f}")
    c4.metric("Neto del día", f"${net:,.2f}")
    c5.metric("WIN / LOSS", f"{wins} / {losses}")

    if not rows:
        st.info("Todavía no hay operaciones MES registradas para este día. Las nuevas entradas se guardarán automáticamente.")
        return

    table = []
    for row in rows:
        opened = str(row.get("opened_at") or "").replace("T", " ")
        closed_at = str(row.get("closed_at") or "").replace("T", " ") if row.get("closed_at") else "—"
        pnl = row.get("realized_pnl")
        table.append({
            "Fecha": row.get("trading_day"),
            "Entrada": opened[11:19] if len(opened) >= 19 else opened,
            "Salida": closed_at[11:19] if len(closed_at) >= 19 else closed_at,
            "Cuenta": row.get("account"),
            "Tipo": row.get("source"),
            "Señal": row.get("strategy") or "MANUAL",
            "Score": round(float(row["score"]), 1) if row.get("score") is not None else "—",
            "Dirección": row.get("direction"),
            "Contratos": int(row.get("quantity") or 0),
            "Precio entrada": round(float(row["entry_price"]), 2) if row.get("entry_price") is not None else "—",
            "Precio salida": round(float(row["exit_price"]), 2) if row.get("exit_price") is not None else "—",
            "TP $": round(float(row.get("take_profit") or 0.0), 2),
            "SL $": round(float(row.get("stop_loss") or 0.0), 2),
            "Resultado $": round(float(pnl), 2) if pnl is not None else "—",
            "Cierre": row.get("close_reason") or ("ABIERTA" if row.get("status") == "OPEN" else "—"),
            "Estado": row.get("status"),
        })
    st.dataframe(pd.DataFrame(table), use_container_width=True, hide_index=True)
    st.caption("El historial es persistente. Si el Bridge entrega precio de salida y P/L realizado se usan esos valores; de lo contrario se conserva la mejor información disponible del ciclo de ejecución.")


# Configuración MES persistente independiente de los widgets de Streamlit.
# Los widgets pueden desaparecer del árbol al cambiar de pestaña; estas keys NO.
MES_PERSISTENT_DEFAULTS = {
    "mes_cfg_account_mode": "SIM",
    "mes_cfg_account": "Sim101",
    "mes_cfg_real_confirmed": False,
    "mes_cfg_firm": "SIM TEST",
    "mes_cfg_contract": "MES 09-26",
    "mes_cfg_bridge_url": "http://127.0.0.1:8765",
    "mes_cfg_bridge_key": "SPXDEFENDER-MES-2026",
    "mes_cfg_qty": 2,
    "mes_cfg_min_score": 90.0,
    "mes_cfg_tp": 100.0,
    "mes_cfg_sl": 100.0,
    "mes_cfg_auto_on": False,
    "mes_cfg_chart_minutes": 5,
    "mes_cfg_chart_bars_back": 120,
}

def ensure_mes_persistent_config():
    for key, default in MES_PERSISTENT_DEFAULTS.items():
        st.session_state.setdefault(key, default)

def mes_cfg(key, default=None):
    ensure_mes_persistent_config()
    return st.session_state.get(f"mes_cfg_{key}", default)

def set_mes_cfg(key, value):
    st.session_state[f"mes_cfg_{key}"] = value


def mes_auto_background_cycle():
    """Motor AUTO MES global.

    Se monta fuera de la pestaña Futuros para que siga evaluando señales y
    enviando órdenes mientras el usuario navega por Mercado, Ideas, SIM, etc.
    La configuración vive en keys persistentes separadas de los widgets, así AUTO MES
    conserva cuenta, modo, riesgo y estado incluso cuando la pestaña deja de renderizarse.
    """
    now = market_time()
    st.session_state["mes_engine_last_cycle"] = now.isoformat(timespec="seconds")

    if not bool(mes_cfg("auto_on", False)):
        st.session_state["mes_engine_status"] = "OFF"
        return

    account = str(mes_cfg("account", "Sim101") or "Sim101").strip()
    bridge_url = str(mes_cfg("bridge_url", "http://127.0.0.1:8765") or "").strip()
    bridge_key = str(mes_cfg("bridge_key", "SPXDEFENDER-MES-2026") or "").strip()
    mes_contract = str(mes_cfg("contract", "MES 09-26") or "MES 09-26").strip().upper()
    qty = max(1, int(mes_cfg("qty", 2) or 2))
    min_score = float(mes_cfg("min_score", 90.0) or 90.0)
    tp = float(mes_cfg("tp", 100.0) or 100.0)
    sl = float(mes_cfg("sl", 100.0) or 100.0)

    account_mode = str(mes_cfg("account_mode", "SIM") or "SIM").strip().upper()
    real_confirmed = bool(mes_cfg("real_confirmed", False))
    if account_mode == "REAL":
        if not account or account.lower() == "sim101":
            st.session_state["mes_engine_status"] = "BLOQUEADO: selecciona/escribe una cuenta REAL válida"
            return
        if not real_confirmed:
            st.session_state["mes_engine_status"] = "BLOQUEADO: confirma explícitamente AUTO MES en cuenta REAL"
            return
    elif not account:
        st.session_state["mes_engine_status"] = "BLOQUEADO: cuenta NinjaTrader vacía"
        return

    start_time = now.replace(hour=9, minute=30, second=0, microsecond=0)
    if now.weekday() >= 5 or now < start_time:
        st.session_state["mes_engine_status"] = "ESPERANDO 9:30 AM ET"
        return
    if not market_is_open(now):
        st.session_state["mes_engine_status"] = "MERCADO CERRADO"
        return

    blackout, event = high_impact_news_blackout(now)
    if blackout:
        label = str((event or {}).get("name") or (event or {}).get("event") or "noticia de alto impacto")
        st.session_state["mes_engine_status"] = f"BLACKOUT NOTICIAS: {label}"
        return

    try:
        live_pos = _mes_bridge_request(
            "GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}", timeout=4.0
        )
        st.session_state["mes_bridge_position"] = live_pos
        st.session_state["mes_bridge_ok"] = True
        st.session_state.pop("mes_bridge_error", None)
    except Exception as exc:
        st.session_state["mes_bridge_ok"] = False
        st.session_state["mes_bridge_error"] = str(exc)
        st.session_state["mes_engine_status"] = f"SIN BRIDGE: {exc}"
        return

    # Mantener el historial sincronizado incluso cuando la pestaña Futuros no está visible.
    _mes_history_sync(account, mes_contract, live_pos)

    if not _mes_position_is_flat(live_pos):
        current = (live_pos.get("position") or {}).get("status", live_pos.get("status", "ACTIVA"))
        st.session_state["mes_engine_status"] = f"POSICIÓN ACTIVA: {current}"
        return

    signal = _best_mes_futures_signal(min_score)
    if not signal:
        st.session_state["mes_engine_status"] = f"BUSCANDO PCS/CCS ≥ {min_score:.1f}"
        return

    signal_id = str(signal.get("id") or "")
    if not signal_id:
        st.session_state["mes_engine_status"] = "SEÑAL SIN ID: omitida por seguridad"
        return

    used = set(st.session_state.get("mes_used_signal_ids", []))
    if signal_id in used:
        st.session_state["mes_engine_status"] = "ESPERANDO SEÑAL NUEVA"
        return

    strategy = str(signal.get("strategy") or "").strip().upper()
    if strategy not in {"PCS", "CCS"}:
        st.session_state["mes_engine_status"] = f"SEÑAL {strategy} NO PERMITIDA"
        return
    direction = "LONG" if strategy == "PCS" else "SHORT"
    score = float(defender.number(signal.get("score")) or 0.0)

    payload = {
        "account": account,
        "instrument": mes_contract,
        "direction": direction,
        "quantity": qty,
        "take_profit_dollars": tp,
        "stop_loss_dollars": sl,
        "client_order_id": f"SPXWEB-AUTO-{signal_id[:16]}",
    }
    try:
        result = _mes_bridge_request("POST", bridge_url, bridge_key, "/orders", payload=payload, timeout=5.0)
        used.add(signal_id)
        st.session_state["mes_used_signal_ids"] = list(used)[-100:]
        st.session_state["mes_last_auto_order"] = {
            "signal_id": signal_id,
            "strategy": strategy,
            "score": score,
            "direction": direction,
        ...
        st.session_state["mes_engine_status"] = f"ENVIADA {strategy} {score:.1f} → {direction} {qty} MES"
    except Exception as exc:
        st.session_state["mes_engine_status"] = f"ERROR ENVÍO: {exc}"


def render_futures_mes_page():
    st.title("🏦 Futuros · MES")
    st.caption("SPX Defender → NinjaTrader 8 → MES · PCS = LONG · CCS = SHORT")

    st.warning("Puedes usar Sim101 o una cuenta REAL de NinjaTrader. Antes de activar AUTO MES en REAL, verifica primero conexión, FLAT, TP/SL y OCO.")

    # Selector de cuenta MUY visible, antes del gráfico.
    ensure_mes_persistent_config()
    st.markdown("### 🏦 Cuenta de ejecución MES")
    top_mode = st.radio(
        "Selecciona dónde operar",
        ["SIM", "REAL"],
        horizontal=True,
        index=0 if str(mes_cfg("account_mode", "SIM")).upper() == "SIM" else 1,
        key="_mes_ui_account_mode",
        help="SIM usa Sim101. REAL permite escribir el nombre/ID exacto de una cuenta real conectada en NinjaTrader.",
    )
    set_mes_cfg("account_mode", top_mode)
    if top_mode == "SIM":
        sim_value = str(mes_cfg("account", "Sim101") or "Sim101")
        if not sim_value or sim_value.lower() != "sim101":
            sim_value = "Sim101"
        sim_account = st.text_input(
            "Cuenta SIM NinjaTrader",
            value=sim_value,
            key="_mes_ui_account_sim",
            help="Para pruebas normales usa Sim101.",
        )
        set_mes_cfg("account", sim_account.strip() or "Sim101")
        set_mes_cfg("real_confirmed", False)
        st.info("🧪 MODO SIM · las órdenes van a la cuenta simulada seleccionada.")
    else:
        real_value = str(mes_cfg("account", "") or "")
        if real_value.lower() == "sim101":
            real_value = ""
        real_account = st.text_input(
            "Cuenta REAL NinjaTrader",
            value=real_value,
            key="_mes_ui_account_real",
            placeholder="Escribe aquí el nombre/ID EXACTO de tu cuenta real",
            help="Debe coincidir exactamente con el nombre de la cuenta que aparece en NinjaTrader/Bridge.",
        )
        set_mes_cfg("account", real_account.strip())
        real_confirmed = st.checkbox(
            "Confirmo que esta es una cuenta REAL y autorizo AUTO MES a enviar órdenes",
            value=bool(mes_cfg("real_confirmed", False)),
            key="_mes_ui_real_confirmed",
        )
        set_mes_cfg("real_confirmed", bool(real_confirmed))
        if real_confirmed:
            st.error("🔴 REAL ARMADO · AUTO MES podrá enviar órdenes reales cuando esté ON.")
        else:
            st.warning("REAL seleccionado, pero todavía BLOQUEADO hasta marcar la confirmación.")

    # Gráfico MES: datos exclusivamente desde NinjaTrader Bridge.
    st.subheader("📈 MES · NinjaTrader")
    chart_controls = st.columns([1, 1, 1, 3])
    mes_tf = chart_controls[0].selectbox(
        "Velas",
        [1, 5, 15],
        index=[1, 5, 15].index(int(mes_cfg("chart_minutes", 5))) if int(mes_cfg("chart_minutes", 5)) in [1, 5, 15] else 1,
        format_func=lambda x: f"{x} min",
        key="_mes_ui_chart_minutes",
    )
    mes_bars_back = chart_controls[1].selectbox(
        "Barras",
        [60, 120, 240, 480],
        index=[60, 120, 240, 480].index(int(mes_cfg("chart_bars_back", 120))) if int(mes_cfg("chart_bars_back", 120)) in [60, 120, 240, 480] else 1,
        key="_mes_ui_chart_bars_back",
    )
    set_mes_cfg("chart_minutes", int(mes_tf))
    set_mes_cfg("chart_bars_back", int(mes_bars_back))
    chart_refresh = chart_controls[2].button(
        "🔄 GRÁFICO",
        use_container_width=True,
        key="mes_refresh_chart",
    )

    mes_chart_error = None
    mes_chart_payload = st.session_state.get("mes_ninja_bars") or {}
    try:
        # Si ya hay conexión o el usuario pide refrescar, pedir barras al mismo Bridge/NinjaTrader.
        if chart_refresh or st.session_state.get("mes_bridge_ok"):
            mes_chart_payload = _mes_bridge_request(
                "GET",
                mes_cfg("bridge_url", "http://127.0.0.1:8765"),
                mes_cfg("bridge_key", "SPXDEFENDER-MES-2026"),
                f"/bars/{urlparse.quote(mes_cfg('contract', 'MES 09-26'), safe='')}/{int(mes_tf)}/{int(mes_bars_back)}",
                timeout=8.0,
            )
            st.session_state["mes_ninja_bars"] = mes_chart_payload
    except Exception as exc:
        mes_chart_error = str(exc)

    bars_rows = (mes_chart_payload or {}).get("bars") or []
    if bars_rows:
        df_mes = pd.DataFrame(bars_rows)
        df_mes["time"] = pd.to_datetime(df_mes["time"], errors="coerce")
        for col in ("open", "high", "low", "close", "volume"):
            df_mes[col] = pd.to_numeric(df_mes[col], errors="coerce")
        df_mes = df_mes.dropna(subset=["time", "open", "high", "low", "close"]).sort_values("time")

        if not df_mes.empty:
            df_mes["up"] = df_mes["close"] >= df_mes["open"]
            wick = alt.Chart(df_mes).mark_rule().encode(
                x=alt.X("time:T", title=None),
                y=alt.Y("low:Q", title="MES"),
                y2="high:Q",
                color=alt.condition("datum.up", alt.value("#21d19f"), alt.value("#ff6276")),
                tooltip=[
            ...
            body = alt.Chart(df_mes).mark_bar(size=5).encode(
                x=alt.X("time:T", title=None),
                y=alt.Y("open:Q", title="MES", scale=alt.Scale(zero=False)),
                y2="close:Q",
                color=alt.condition("datum.up", alt.value("#21d19f"), alt.value("#ff6276")),
            )
            st.altair_chart((wick + body).properties(height=470), use_container_width=True)
            last_bar = df_mes.iloc[-1]
            st.caption(
                f"NinjaTrader · {mes_chart_payload.get('instrument', mes_cfg('contract', 'MES'))} · "
                f"{int(mes_tf)}m · Último {float(last_bar['close']):,.2f}"
            )
        else:
            st.info("NinjaTrader respondió, pero no devolvió barras MES válidas.")
    else:
        if mes_chart_error:
            st.warning(f"Gráfico MES sin datos de NinjaTrader: {mes_chart_error}")
        else:
            st.info("Pulsa PROBAR CONEXIÓN y luego 🔄 GRÁFICO para cargar las velas MES directamente desde NinjaTrader.")

    left, right = st.columns([1.1, 1])
    with left:
        st.subheader("Conexión NinjaTrader")
        account_mode = str(mes_cfg("account_mode", "SIM") or "SIM").upper()
        account = str(mes_cfg("account", "Sim101") or "").strip()
        firm = st.text_input("Compañía / modo", value=str(mes_cfg("firm", "SIM TEST")), key="_mes_ui_firm")
        set_mes_cfg("firm", firm)
        st.caption(f"Cuenta seleccionada arriba: **{account_mode} · {account or 'SIN CUENTA'}**")
        mes_contract = st.text_input("Contrato MES NinjaTrader", value=str(mes_cfg("contract", "MES 09-26")), key="_mes_ui_contract", help="Nombre completo del contrato en NinjaTrader. Para septiembre de 2026: MES 09-26")
        set_mes_cfg("contract", mes_contract.strip().upper())
        bridge_url = st.text_input("Bridge URL", value=str(mes_cfg("bridge_url", "http://127.0.0.1:8765")), key="_mes_ui_bridge_url")
        set_mes_cfg("bridge_url", bridge_url.strip())
        bridge_key = st.text_input("Bridge Key", value=str(mes_cfg("bridge_key", "SPXDEFENDER-MES-2026")), type="password", key="_mes_ui_bridge_key")
        set_mes_cfg("bridge_key", bridge_key)

        test_col, status_col = st.columns([1, 1])
        if test_col.button("🔌 PROBAR CONEXIÓN", use_container_width=True, key="mes_test_bridge"):
            try:
                health = _mes_bridge_request("GET", bridge_url, bridge_key, "/health")
                pos = _mes_bridge_request("GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}")
                bars = _mes_bridge_request(
                    "GET", bridge_url, bridge_key,
                    f"/bars/{urlparse.quote(str(mes_contract).strip().upper(), safe='')}/5/120",
                    timeout=8.0,
                )
                st.session_state["mes_bridge_health"] = health
                st.session_state["mes_bridge_position"] = pos
                st.session_state["mes_ninja_bars"] = bars
                st.session_state["mes_bridge_ok"] = True
            except Exception as exc:
                st.session_state["mes_bridge_ok"] = False
                st.session_state["mes_bridge_error"] = str(exc)

        if st.session_state.get("mes_bridge_ok"):
            status_col.success("🟢 CONECTADO")
            pos = st.session_state.get("mes_bridge_position") or {}
            p = pos.get("position") or {}
            st.success(f"Bridge OK · Cuenta {account} · Estado {p.get('status', pos.get('status', '—'))}")
        elif st.session_state.get("mes_bridge_error"):
            status_col.error("🔴 SIN CONEXIÓN")
            st.error(st.session_state.get("mes_bridge_error"))
        else:
            status_col.info("⚪ SIN PROBAR")

    with right:
        st.subheader("Reglas iniciales")
        c1, c2 = st.columns(2)
        qty = c1.number_input("Contratos MES", min_value=1, max_value=10, value=int(mes_cfg("qty", 2)), step=1, key="_mes_ui_qty")
        set_mes_cfg("qty", int(qty))
        min_score = c2.number_input("Score mínimo", min_value=80.0, max_value=100.0, value=float(mes_cfg("min_score", 90.0)), step=0.5, key="_mes_ui_min_score")
        set_mes_cfg("min_score", float(min_score))
        tp = c1.number_input("TP por trade ($)", min_value=5.0, max_value=1000.0, value=float(mes_cfg("tp", 100.0)), step=5.0, key="_mes_ui_tp")
        set_mes_cfg("tp", float(tp))
        sl = c2.number_input("SL por trade ($)", min_value=5.0, max_value=2000.0, value=float(mes_cfg("sl", 100.0)), step=5.0, key="_mes_ui_sl")
        set_mes_cfg("sl", float(sl))
        st.markdown("**Traducción de señales**")
        st.write("✅ PCS de alta calidad → **LONG MES**")
        st.write("✅ CCS de alta calidad → **SHORT MES**")
        st.write("🛡️ Solo **1 posición** a la vez. La cuenta debe estar FLAT antes de otra entrada.")
        auto_on = st.toggle("AUTO MES", value=bool(mes_cfg("auto_on", False)), key="_mes_ui_auto_on")
        set_mes_cfg("auto_on", bool(auto_on))
        if auto_on:
            if str(mes_cfg("account_mode", "SIM")).upper() == "REAL":
                if mes_cfg("real_confirmed", False):
                    st.error(f"🔴 AUTO MES REAL ACTIVADO · Cuenta {str(mes_cfg('account', '') or '—')}")
                else:
                    st.warning("AUTO MES está ON, pero REAL permanece BLOQUEADO hasta marcar la confirmación de cuenta real.")
            else:
                st.warning("AUTO MES está activado en SIM.")
        else:
            st.info("AUTO MES está OFF. Puedes probar la conexión sin enviar órdenes.")

    # El motor AUTO MES corre globalmente fuera de esta pestaña.
    # Aquí solo mostramos su estado y conservamos todos los controles funcionales.
    engine_status = str(st.session_state.get("mes_engine_status", "OFF") or "OFF")
    engine_cycle = str(st.session_state.get("mes_engine_last_cycle", "") or "")
    if auto_on:
        st.success(f"🟢 AUTO MES GLOBAL · {engine_status}")
        if engine_cycle:
            st.caption(f"Motor activo aunque cambies de pestaña · último ciclo {engine_cycle.replace('T', ' ')} ET")
    else:
        st.info("AUTO MES global está OFF. Los controles quedan listos para activarlo cuando quieras.")

    last_auto = st.session_state.get("mes_last_auto_order")
    if last_auto:
        st.caption(
            f"Última AUTO: {last_auto.get('strategy')} {float(last_auto.get('score') or 0):.1f} → "
            f"{last_auto.get('direction')} · {str(last_auto.get('sent_at') or '').replace('T', ' ')}"
        )

    st.divider()
    st.subheader("Estado de la cuenta MES")
    refresh = st.button("🔄 ACTUALIZAR ESTADO", key="mes_refresh_status")
    if refresh:
        try:
            pos = _mes_bridge_request("GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}")
            st.session_state["mes_bridge_position"] = pos
            st.session_state["mes_bridge_ok"] = True
            _mes_history_sync(account, str(mes_contract).strip().upper(), pos)
        except Exception as exc:
            st.session_state["mes_bridge_ok"] = False
            st.session_state["mes_bridge_error"] = str(exc)
            st.error(str(exc))
    ...
    m1, m2, m3, m4 = st.columns(4)
    m1.metric("Cuenta", account or "—")
    m2.metric("MES", position.get("status", pos.get("status", "—")))
    m3.metric("Cantidad", position.get("quantity", 0))
    m4.metric("Protegida", "SÍ" if position.get("protected") else "NO")

    render_mes_trade_history()

    st.divider()
    st.subheader("🧪 Prueba manual MES · SOLO Sim101")
    st.caption("Los botones manuales siguen bloqueados a Sim101 por seguridad. El motor AUTO MES sí puede usar la cuenta REAL seleccionada arriba cuando esté confirmada.")
    st.caption("Usa estos botones únicamente para verificar el Bridge. La prueba respeta 1 posición a la vez y usa el TP/SL configurados arriba.")

    sim_only = str(account or "").strip().lower() == "sim101"
    current_status = str(position.get("status", pos.get("status", "")) or "").strip().upper()
    working_orders = bool(pos.get("working_orders"))
    account_flat = current_status in {"", "FLAT", "NONE", "0"} and not working_orders

    if not sim_only:
        st.error("Por seguridad, los botones de prueba manual solo funcionan cuando la cuenta es Sim101.")

    close_test_col, _close_spacer = st.columns([1, 2])
    if close_test_col.button(
        "⛔ CERRAR MES / FLAT",
        use_container_width=True,
        key="mes_manual_flatten",
        disabled=not sim_only or not st.session_state.get("mes_bridge_ok"),
        help="Solo Sim101. Cancela órdenes MES y deja la posición MES en FLAT.",
    ):
        try:
            result = _mes_bridge_request(
                "POST", bridge_url, bridge_key, "/flatten",
                payload={"account": account, "instrument": str(mes_contract).strip().upper()},
                timeout=5.0,
            )
            st.success(f"Orden FLAT enviada: {result.get('status', 'FLATTENING')}")
            time.sleep(0.5)
            st.session_state["mes_bridge_position"] = _mes_bridge_request(
                "GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}"
            )
        except Exception as exc:
            st.error(f"No se pudo cerrar MES: {exc}")

    test_long_col, test_short_col = st.columns(2)
    # No depender de un estado viejo de Streamlit: el Bridge valida FLAT al pulsar.
    test_disabled = (not sim_only) or (not st.session_state.get("mes_bridge_ok"))

    if test_long_col.button("🟢 PRUEBA LONG MES", use_container_width=True, key="mes_manual_test_long", disabled=test_disabled):
        try:
            live_check = _mes_bridge_request("GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}")
            st.session_state["mes_bridge_position"] = live_check
            if not _mes_position_is_flat(live_check):
                st.warning("Sim101 todavía tiene una posición u orden activa. Usa CERRAR MES / FLAT o espera el cierre.")
                return
            payload = {
                "account": account,
                "instrument": str(mes_contract).strip().upper(),
                "direction": "LONG",
                "quantity": int(qty),
                "take_profit_dollars": float(tp),
                "stop_loss_dollars": float(sl),
                "client_order_id": f"SPXWEB-TEST-LONG-{int(time.time())}",
            }
            result = _mes_bridge_request("POST", bridge_url, bridge_key, "/orders", payload=payload, timeout=5.0)
            st.session_state["mes_last_manual_order"] = result
            _mes_history_open_trade(
                account=account, instrument=str(mes_contract).strip().upper(), direction="LONG",
                quantity=int(qty), tp=float(tp), sl=float(sl), source="MANUAL",
                client_order_id=payload.get("client_order_id"), bridge_result=result,
            )
            st.success(f"Orden de prueba LONG enviada a {account}: {result.get('status', 'SENT')}")
            time.sleep(0.4)
            st.session_state["mes_bridge_position"] = _mes_bridge_request("GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}")
        except Exception as exc:
            st.error(f"No se pudo enviar LONG MES: {exc}")

    if test_short_col.button("🔴 PRUEBA SHORT MES", use_container_width=True, key="mes_manual_test_short", disabled=test_disabled):
        try:
            live_check = _mes_bridge_request("GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}")
            st.session_state["mes_bridge_position"] = live_check
            if not _mes_position_is_flat(live_check):
            ...
            payload = {
                ...
                "take_profit_dollars": float(tp),
                "stop_loss_dollars": float(sl),
                "client_order_id": f"SPXWEB-TEST-SHORT-{int(time.time())}",
            }
            result = _mes_bridge_request("POST", bridge_url, bridge_key, "/orders", payload=payload, timeout=5.0)
            st.session_state["mes_last_manual_order"] = result
            _mes_history_open_trade(
                account=account, instrument=str(mes_contract).strip().upper(), direction="SHORT",
                quantity=int(qty), tp=float(tp), sl=float(sl), source="MANUAL",
                client_order_id=payload.get("client_order_id"), bridge_result=result,
            )
            st.success(f"Orden de prueba SHORT enviada a {account}: {result.get('status', 'SENT')}")
            time.sleep(0.4)
            st.session_state["mes_bridge_position"] = _mes_bridge_request("GET", bridge_url, bridge_key, f"/positions/{urlparse.quote(account)}")
        except Exception as exc:
            st.error(f"No se pudo enviar SHORT MES: {exc}")

    if not account_flat:
        st.info("Hay una posición u orden activa. Cierra primero esa prueba en NinjaTrader/Sim101 antes de enviar la prueba contraria.")

    last_manual = st.session_state.get("mes_last_manual_order")
    if last_manual:
        st.caption(f"Último envío manual: {last_manual}")

    st.caption(
        "Secuencia obligatoria: SIGNAL → SENT → FILLED → PROTECTED → CLOSED/FLAT → VERIFIED. "
        "Mientras exista una posición u orden pendiente, no se permite una señal contraria ni otra entrada."
    )

_nav_labels = {
    "📈 Mercado": "MARKET",
    "🛡️ Analizar operación": "ANALYZE",
    "💡 Ideas de trades": "TRADE IDEAS",
    "📊 Simulador de opciones": "STRATEGY LAB",
    "📋 Mis operaciones": "POSITIONS",
    "🤖 Auto Trading SIM": "AUTO SIM",
    "💵 Auto Trading REAL": "AUTO REAL",
    "🏦 Futuros · MES": "FUTURES MES",
    "🧠 Robot de Portafolio": "PORTFOLIO",
}
page = st.radio(
    ...
    key="main_nav_primary",
    format_func=lambda value: _nav_labels[value],
)

# Motor AUTO MES persistente dentro de la sesión: se monta en TODAS las páginas.
# Así no se detiene al salir de la pestaña Futuros · MES.
use_fragment(mes_auto_background_cycle, 5)

# Navegación interna: nunca dependas del botón Atrás del navegador.
# El callback cambia la pestaña antes del rerun, por lo que conserva la sesión/login.
def _go_market():
    st.session_state["main_nav_primary"] = "📈 Mercado"

if page != "📈 Mercado":
    back_a, back_b = st.columns([1.15, 5.85])
    with back_a:
        st.button(
            "← VOLVER AL MERCADO",
            key=f"back_to_market_{page}",
            use_container_width=True,
            on_click=_go_market,
        )
...
try:
    ...
    st.info("Si dice que Tradier rechazó el token, abre ⚡ Conexión de datos LIVE en el lateral y vuelve a guardar tu API token LIVE. Si el token está correcto, prueba otro símbolo.")
    st.stop()
...
with st.sidebar:
    ...
    if st.button("🔄 Actualizar datos", use_container_width=True):
        clear_data()
        st.rerun()
    st.caption("Conexión de datos: Tradier Brokerage · LIVE")
    try:
...
if page == "📈 Mercado":
    st.markdown(
        ...
        section[data-testid="stSidebar"]{display:none!important}
        [data-testid="stSidebarCollapsedControl"]{display:none!important}
        [data-testid="stMainBlockContainer"]{max-width:100%!important;padding:0.55rem 1.1rem 1.4rem!important}
        [data-testid="stHeader"]{height:0!important;background:transparent!important}
        [data-testid="stToolbar"]{display:none!important}
        .spx-pro-shell,.terminal-market-header{display:none!important}
        .mock-topbar{display:grid;grid-template-columns:270px minmax(230px,1fr) repeat(3,minmax(92px,.36fr)) 150px;align-items:center;gap:0;background:#07111d;border-bottom:1px solid #17314a;min-height:76px;margin:-.55rem -1.1rem 1rem;padding:0 1.2rem;box-shadow:0 8px 30px rgba(0,0,0,.18)}
        .mock-brand{display:flex;align-items:center;gap:.72rem;border-right:1px solid #20354a;padding-right:1rem;height:50px}.mock-shield{width:43px;height:49px;clip-path:polygon(50% 0,92% 16%,85% 72%,50% 100%,15% 72%,8% 16%);background:linear-gradient(155deg,#e9f6ff 0%,#83bff1 22%,#0b2943 24%,#0a1725 100%);position:relative}.mock-shield:after{content:"SPX";display:grid;place-items:center;position:absolute;inset:4px;clip-path:inherit;background:#081321;color:#dff2ff;font-size:.69rem;font-weight:900}.mock-brandname{font-size:1.13rem;font-weight:850;color:#edf6ff;letter-spacing:.03em;line-height:1.05}.mock-brandtag{font-size:.54rem;color:#6f86a0;letter-spacing:.24em;margin-top:.28rem;font-weight:750}
        .mock-symbol{display:flex;align-items:center;gap:1rem;padding:0 1rem}.mock-symbol-name{font-size:.93rem;color:#afc6db;font-weight:800}.mock-symbol-price{font-size:1.28rem;color:#f4f8ff;font-weight:850}.mock-symbol-live{font-size:.61rem;color:#7890a8;margin-top:.2rem}.mock-mini-chart{flex:1;height:30px;min-width:70px}.mock-mini-chart svg{width:100%;height:100%}.mock-topmetric{border-left:1px solid #183047;padding-left:.9rem}.mock-topmetric span{display:block;color:#8aa0b5;font-size:.62rem;font-weight:760}.mock-topmetric strong{display:block;color:#f0f6ff;font-size:.85rem;margin-top:.15rem}.mock-topmetric small{display:block;color:#33d99a;font-size:.61rem;margin-top:.1rem}.mock-connected{justify-self:end;display:flex;align-items:center;gap:.5rem;border:1px solid #24435e;border-radius:999px;padding:.55rem .9rem;color:#e4eef8;font-size:.7rem;font-weight:800}.mock-connected i{width:9px;height:9px;border-radius:50%;background:#18d68d;box-shadow:0 0 0 4px rgba(24,214,141,.12)}
        div[data-testid="stMain"] div[data-testid="stRadio"]>label{display:none!important}div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"]{display:grid!important;grid-template-columns:repeat(8,minmax(120px,1fr))!important;gap:10px!important;padding:0!important;margin:0 0 1rem!important;background:transparent!important;border:0!important;overflow-x:auto!important}div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"] label{min-height:66px!important;margin:0!important;padding:.85rem .75rem!important;border:1px solid #17334e!important;border-radius:7px!important;background:#091522!important;display:flex!important;align-items:center!important;justify-content:center!important;position:relative!important}div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"] label:has(input:checked){background:linear-gradient(180deg,#0e2941,#0a1b2c)!important;border-color:#195d83!important;box-shadow:inset 0 -2px 0 #19d4ff,0 8px 20px rgba(0,141,204,.08)!important}div[data-testid="stMain"] div[data-testid="stRadio"] [data-baseweb="radio"]>div:first-child{display:none!important}div[data-testid="stMain"] div[data-testid="stRadio"] [data-testid="stMarkdownContainer"] p{margin:0!important;color:#d9e6f3!important;font-size:.81rem!important;font-weight:800!important;white-space:nowrap!important;text-align:center!important}
        .mock-card{background:#081522;border:1px solid #173650;border-radius:7px;overflow:hidden;margin-bottom:.8rem}.mock-card-title{padding:.72rem .85rem;border-bottom:1px solid #173047;color:#dce8f4;font-size:.69rem;font-weight:850}.mock-card-body{padding:.58rem .85rem}.mock-row{display:grid;grid-template-columns:1fr auto auto;gap:.55rem;align-items:center;padding:.5rem 0;border-bottom:1px solid rgba(27,52,75,.68);font-size:.68rem}.mock-row:last-child{border-bottom:0}.mock-row span{color:#91a7bc}.mock-row b{color:#edf5ff}.mock-row em{font-style:normal;color:#22db95;font-weight:800}.mock-row em.red{color:#ff5f68}
        .watch-meta{display:grid;grid-template-columns:1fr auto auto;gap:.45rem;align-items:center;margin-top:-.30rem;margin-bottom:.38rem;padding:0 .68rem .38rem;border-bottom:1px solid rgba(27,52,75,.45);font-size:.62rem}.watch-meta span{color:#8ea5ba}.watch-meta b{color:#edf5ff;font-size:.68rem}.watch-meta em{font-style:normal;font-weight:800;font-size:.61rem}.watch-up{color:#22db95}.watch-down{color:#ff5f68}

        .mock-gauge-wrap{padding:.85rem .7rem .75rem;text-align:center}.mock-gauge{width:150px;height:76px;margin:0 auto;position:relative;overflow:hidden}.mock-gauge-arc{position:absolute;width:138px;height:138px;left:6px;top:4px;border-radius:50%;background:conic-gradient(from 270deg,#f24f4f 0deg,#ef9d3c 48deg,#d7db4c 85deg,#33d381 135deg,transparent 135deg 360deg);-webkit-mask:radial-gradient(circle at center,transparent 0 54px,#000 55px);mask:radial-gradient(circle at center,transparent 0 54px,#000 55px)}.mock-gauge-score{position:absolute;left:0;right:0;bottom:0;color:#2ee28f;font-size:1.8rem;font-weight:900}.mock-gauge-label{margin-top:.25rem;color:#29d88b;font-size:.67rem;font-weight:850}.mock-flow{display:grid;grid-template-columns:1fr 1fr;gap:.6rem;margin-bottom:.45rem}.mock-flow span{font-size:.62rem;color:#8ca3b9}.mock-flow b{display:block;font-size:.78rem;margin-top:.15rem}.mock-flow .call b{color:#21da91}.mock-flow .put{text-align:right}.mock-flow .put b{color:#ff5966}.mock-flowbar{height:6px;background:#ff515e;border-radius:999px;overflow:hidden}.mock-flowbar i{display:block;height:100%;background:#1ed68c}
        .mock-chart-card{background:#07131f;border:1px solid #173650;border-radius:7px;overflow:hidden;min-height:630px}.mock-chart-title{display:flex;justify-content:space-between;padding:.72rem .9rem;border-bottom:1px solid #173047}.mock-chart-title b{font-size:.7rem;color:#dce8f4}.mock-chart-title span{font-size:.61rem;color:#2add97;font-weight:800}.mock-tf{display:flex;gap:.35rem;padding:.52rem .9rem 0}.mock-tf span{padding:.3rem .48rem;border-radius:5px;color:#8fa4b9;font-size:.63rem}.mock-tf span.active{background:#154872;color:#eef8ff;font-weight:800}
        .mock-side-item{padding:.65rem .8rem;border-bottom:1px solid rgba(27,52,75,.72)}.mock-side-time{display:inline-block;min-width:67px;color:#9eb2c5;font-size:.66rem}.mock-side-name{color:#e4edf7;font-size:.68rem}.mock-side-sub{display:block;margin-left:70px;color:#758ba1;font-size:.61rem;margin-top:.2rem}.mock-alert{display:grid;grid-template-columns:1fr 10px;gap:.4rem;align-items:center;padding:.68rem .8rem;border-bottom:1px solid rgba(27,52,75,.72)}.mock-alert b{display:block;color:#dce8f4;font-size:.68rem}.mock-alert span{display:block;color:#758da5;font-size:.61rem;margin-top:.15rem}.mock-alert i{width:8px;height:8px;border-radius:50%;background:#21d98d}.mock-alert i.off{background:#7086a0}
        .mock-bottom{background:#081522;border:1px solid #173650;border-radius:7px;padding:.75rem .85rem;margin-top:.85rem}.mock-bottom-title{font-size:.67rem;color:#dce8f4;font-weight:850;margin-bottom:.65rem}.mock-level-grid{display:grid;grid-template-columns:repeat(8,minmax(115px,1fr));gap:.45rem;overflow-x:auto}.mock-level-box{background:#091724;border:1px solid #173047;border-radius:5px;padding:.65rem .55rem;text-align:center}.mock-level-box span{display:block;color:#a0b3c5;font-size:.58rem}.mock-level-box b{display:block;margin-top:.35rem;color:#29d993;font-size:.84rem}.mock-level-box b.red{color:#ff5f67}.mock-level-box b.blue{color:#57a9ff}.mock-level-box b.orange{color:#ffb45f}
        @media(max-width:1100px){.mock-topbar{grid-template-columns:250px 1fr 110px 110px}.mock-topmetric:nth-of-type(n+3){display:none}.mock-connected{display:none}div[data-testid="stMain"] div[data-testid="stRadio"] div[role="radiogroup"]{grid-template-columns:repeat(8,150px)!important}}
        </style>
        ''', unsafe_allow_html=True)

    with st.expander("⚙ MARKET CONTROLS", expanded=False):
        first_setting, second_setting, third_setting = st.columns([1.3, 1, 1])
        market_expiration = first_setting.selectbox("Vencimiento", expirations, format_func=expiration_name)
        interval = second_setting.selectbox("Velas", list(CANDLE_INTERVAL_LABELS), index=1, format_func=lambda value: CANDLE_INTERVAL_LABELS[value])
        strike_range = third_setting.select_slider("Rango de strikes", options=[50,75,100,150,200,300,400], value=100)
        option_cols = st.columns(7)
        chart_settings = {"ema9": option_cols[0].checkbox("EMA 9", value=True), "ema21": option_cols[1].checkbox("EMA 21", value=True), "vwap": option_cols[2].checkbox("VWAP", value=True), "volume": option_cols[3].checkbox("Volumen", value=True), "levels": option_cols[4].checkbox("Niveles", value=True), "expected_range": option_cols[5].checkbox("Rango esperado", value=True)}
        chart_settings["visible_candles"] = option_cols[6].selectbox("Velas visibles", [30,45,60,80,100,120,150,180], index=3)

    def market_panel():
        try:
            spx = load_spx(selected_symbol()); options = load_chain(market_expiration, selected_symbol())
            summary = summarize_chain(options, spx, strike_range)
            expected = calculate_expected_levels(options, spx, market_expiration, summary["frame"], strike_range)
        except Exception as error:
            st.error(f"No se pudo cargar el mercado: {error}"); return
        ratio = summary["put_oi"] / summary["call_oi"] if summary["call_oi"] else None
        total_oi = float(summary["put_oi"] or 0)+float(summary["call_oi"] or 0)
        call_pct = float(summary["call_oi"] or 0)/total_oi*100 if total_oi else 50.0; put_pct = 100-call_pct
        gamma_flip = expected.get("gamma_flip")
        sentiment = 50 + (max(-22,min(22,(1-ratio)*30)) if ratio is not None else 0) + (8 if gamma_flip is not None and spx >= gamma_flip else -8 if gamma_flip is not None else 0)
        sentiment = int(max(0,min(100,round(sentiment)))); sentiment_label = "ALCISTA" if sentiment>=58 else "BAJISTA" if sentiment<=42 else "NEUTRAL"
        atm_iv = f"{expected['atm_iv']*100:.1f}%" if expected.get("atm_iv") else "N/D"
        put_wall_text = f"{summary['put_wall']:,.0f}" if summary['put_wall'] is not None else "N/D"; call_wall_text = f"{summary['call_wall']:,.0f}" if summary['call_wall'] is not None else "N/D"; mvs_text = f"{summary['mvs']:,.0f}" if summary['mvs'] is not None else "N/D"; ratio_text=f"{ratio:.2f}" if ratio is not None else "N/D"; gamma_flip_text=f"{gamma_flip:,.1f}" if gamma_flip is not None else "N/D"; daily_move_text=f"±{expected['daily_move']:,.1f}" if expected.get('daily_move') is not None else "N/D"; daily_lower_text=f"{expected['daily_lower']:,.1f}" if expected.get('daily_lower') is not None else "N/D"; daily_upper_text=f"{expected['daily_upper']:,.1f}" if expected.get('daily_upper') is not None else "N/D"; net_gamma_text=compact(summary["gamma_levels"]["net_gamma"]) if summary["has_greeks"] else "N/D"
        bias = "Bajista" if ratio is not None and ratio > 1 else "Alcista" if ratio is not None else "N/D"; gamma_bias="Positivo" if gamma_flip is not None and spx>=gamma_flip else "Negativo" if gamma_flip is not None else "N/D"
        now_text = market_time().strftime("%I:%M:%S %p")
        st.markdown(f'''<div class="mock-topbar"><div class="mock-brand"><div class="mock-shield"></div><div><div class="mock-brandname">SPX DEFENDER</div><div class="mock-brandtag">OPTIONS INTELLIGENCE</div></div></div><div class="mock-symbol"><div><div><span class="mock-symbol-name">{escape(selected_symbol())}</span>&nbsp;&nbsp;<span class="mock-symbol-price">{spx:,.2f}</span></div><div class="mock-symbol-live">LIVE · {now_text} ET</div></div></div><div class="mock-topmetric"><span>ATM IV</span><strong>{atm_iv}</strong><small>LIVE</small></div><div class="mock-topmetric"><span>PCR</span><strong>{ratio_text}</strong><small>{bias}</small></div><div class="mock-topmetric"><span>GAMMA</span><strong>{net_gamma_text}</strong><small>{gamma_bias}</small></div><div class="mock-connected">CONECTADO <i></i></div></div>''', unsafe_allow_html=True)
        left_col, chart_col, right_col = st.columns([0.86, 2.55, 0.9], gap="medium")
        ...
        if "market_chart_symbol" not in st.session_state:
            st.session_state["market_chart_symbol"] = selected_symbol()
        chart_symbol = str(st.session_state.get("market_chart_symbol") or selected_symbol()).upper()

        def watch_quote(symbol_code):
            try:
                quote = load_spx_quote(symbol_code)
                price = 0.0
                for field in ("last", "close", "prevclose"):
                    price = defender.number(quote.get(field))
                    if price > 0:
                        break
                prev = defender.number(quote.get("prevclose"))
                pct = ((price - prev) / prev * 100.0) if price > 0 and prev > 0 else None
                return price, pct
            except Exception:
                return None, None

        with left_col:
            st.markdown('<div class="mock-card-title" style="border:1px solid #173650;border-radius:7px 7px 0 0;background:#081522">RESUMEN DE MERCADO</div>', unsafe_allow_html=True)
            for display_name, symbol_code in watch_symbols:
                price_value, pct_value = watch_quote(symbol_code)
                selected_watch = chart_symbol == symbol_code
                button_label = f"{'● ' if selected_watch else ''}{display_name}"
                if st.button(button_label, key=f"watch_{symbol_code}", use_container_width=True):
                    st.session_state["market_chart_symbol"] = symbol_code
                    st.rerun()
                price_text = f"{price_value:,.2f}" if price_value is not None else "N/D"
                pct_text = f"{pct_value:+.2f}%" if pct_value is not None else ""
                pct_class = "watch-up" if pct_value is not None and pct_value >= 0 else "watch-down"
                st.markdown(
                    f'<div class="watch-meta"><span>{escape(display_name)}</span><b>{price_text}</b><em class="{pct_class}">{pct_text}</em></div>',
                    unsafe_allow_html=True,
                )

            st.markdown(f'''<div class="mock-card"><div class="mock-card-title">SENTIMIENTO DEL MERCADO</div><div class="mock-gauge-wrap"><div class="mock-gauge"><div class="mock-gauge-arc"></div><div class="mock-gauge-score">{sentiment}</div></div><div class="mock-gauge-label">{sentiment_label}</div></div></div>''', unsafe_allow_html=True)
            st.markdown(f'''<div class="mock-card"><div class="mock-card-title">FLUJO DE OPCIONES HOY</div><div class="mock-card-body"><div class="mock-flow"><div class="call"><span>CALLS</span><b>{call_pct:.0f}%</b></div><div class="put"><span>PUTS</span><b>{put_pct:.0f}%</b></div></div><div class="mock-flowbar"><i style="width:{call_pct:.1f}%"></i></div></div></div>''', unsafe_allow_html=True)

        with chart_col:
            chart_display = next((name for name, code in watch_symbols if code == chart_symbol), chart_symbol)
            try:
                candles = load_candles(interval, chart_symbol)
                try:
                    candles = update_live_candles(candles, load_spx_quote(candles["symbol"]))
                except Exception:
                    candles = {**candles, "is_live": False}
                try:
                    chart_price = load_spx(chart_symbol)
                except Exception:
                    chart_price = spx
                same_options_symbol = chart_symbol == selected_symbol()
                show_candles(
                    candles,
                    summary["put_wall"] if same_options_symbol else None,
                    summary["call_wall"] if same_options_symbol else None,
                    expected=expected if same_options_symbol else None,
                    spx=chart_price,
                    mvs=summary["mvs"] if same_options_symbol else None,
                    settings={**chart_settings, "volume": False},
                )
            except Exception as error:
                st.warning(f"No se pudo mostrar el gráfico de {chart_display}: {error}")

        with right_col:
            news_times=configured_high_impact_news_times(market_time().date())
            items="".join(f'<div class="mock-side-item"><span class="mock-side-time">{evt.strftime("%I:%M %p")}</span><span class="mock-side-name">Noticia 3★ configurada</span><span class="mock-side-sub">Blackout ±{NEWS_BLACKOUT_MINUTES} min</span></div>' for evt in news_times[:4]) if news_times else '<div class="mock-side-item"><span class="mock-side-name">Sin eventos 3★ configurados para hoy</span><span class="mock-side-sub">Filtro listo para los horarios configurados.</span></div>'
            st.markdown(f'<div class="mock-card"><div class="mock-card-title">▣ &nbsp; EVENTOS IMPORTANTES</div>{items}</div>', unsafe_allow_html=True)
            alerts=[]
            if summary.get("call_wall") is not None: alerts.append((f"Call Wall {summary['call_wall']:,.0f}","Resistencia activa",spx>=float(summary['call_wall'])-20))
            if summary.get("put_wall") is not None: alerts.append((f"Put Wall {summary['put_wall']:,.0f}","Soporte activo",spx<=float(summary['put_wall'])+20))
            if gamma_flip is not None: alerts.append((f"Gamma Flip {gamma_flip:,.0f}","Cambio de régimen",abs(spx-gamma_flip)<=25))
            alert_html="".join(f'<div class="mock-alert"><div><b>{escape(name)}</b><span>{escape(note)}</span></div><i class="{("" if active else "off")}"></i></div>' for name,note,active in alerts) or '<div class="mock-alert"><div><b>Mercado conectado</b><span>Sin alertas disponibles</span></div><i class="off"></i></div>'
            st.markdown(f'<div class="mock-card"><div class="mock-card-title">♧ &nbsp; ALERTAS ACTIVAS</div>{alert_html}</div>', unsafe_allow_html=True)
        st.markdown(f'''<div class="mock-bottom"><div class="mock-bottom-title">NIVELES SPX</div><div class="mock-level-grid"><div class="mock-level-box"><span>PUT WALL</span><b>{put_wall_text}</b></div><div class="mock-level-box"><span>CALL WALL</span><b class="red">{call_wall_text}</b></div><div class="mock-level-box"><span>MVS</span><b class="orange">{mvs_text}</b></div><div class="mock-level-box"><span>GAMMA FLIP</span><b class="blue">{gamma_flip_text}</b></div><div class="mock-level-box"><span>RANGO BAJO</span><b>{daily_lower_text}</b></div><div class="mock-level-box"><span>RANGO ALTO</span><b class="red">{daily_upper_text}</b></div><div class="mock-level-box"><span>ATM IV</span><b class="blue">{atm_iv}</b></div><div class="mock-level-box"><span>PUT / CALL</span><b>{ratio_text}</b></div></div></div>''', unsafe_allow_html=True)
        with st.expander("OPTION CHAIN · OPEN INTEREST (TABLA)", expanded=False):
    ...
    st.markdown("### 🔎 Buscar ideas manualmente por vencimiento")
    st.caption(
        "Selecciona el vencimiento que quieras revisar. SPX Defender analizará la cadena LIVE "
        "de ese día y mostrará las mejores ideas disponibles de PCS, CCS e Iron Condor. "
        "No está limitado a 0DTE."
    )

    manual_one, manual_two, manual_three = st.columns([1.25, 1.05, 1])
    manual_expiration = manual_one.selectbox(
        "Vencimiento para buscar",
        expirations,
        format_func=expiration_name,
        key="manual_idea_expiration",
    )
    manual_strategies = manual_two.multiselect(
        "Estrategias",
        ["PCS", "CCS", "Iron Condor"],
        default=["PCS", "CCS", "Iron Condor"],
        key="manual_idea_strategies",
    )
    manual_max_results = manual_three.selectbox(
        "Ideas por estrategia",
        [1, 2, 3],
        index=0,
        key="manual_idea_max_results",
    )

    if st.button(
        "🔍 BUSCAR MEJORES IDEAS PARA ESE VENCIMIENTO",
        key="manual_idea_search_button",
        use_container_width=True,
        type="primary",
    ):
        try:
            settings = automatic_scanner_settings(selected_symbol(), current_spx, expirations)
            generated, manual_summary, manual_expected, manual_spot = generate_ideas(
                manual_expiration,
                settings["width"],
                settings["minimum_credit"],
                settings["maximum_risk"],
            ...
            manual_context = automatic_market_context(
                selected_symbol(), manual_spot, manual_summary, manual_expected
            )
            manual_candidates = {
                "PCS": generated.get("PCS", []),
                "CCS": generated.get("CCS", []),
            ...
            for strategy_name in manual_strategies:
                scored = [
                    score_automatic_candidate(candidate, manual_context)
                    for candidate in manual_candidates.get(strategy_name, [])
                ]
                scored.sort(key=lambda item: (float(item.get("score") or 0), float(item.get("confidence") or 0)), reverse=True)
                results[strategy_name] = scored[: int(manual_max_results)]
            st.session_state["manual_idea_results"] = results
            st.session_state["manual_idea_context"] = manual_context
            st.session_state["manual_idea_result_expiration"] = manual_expiration
            st.session_state["manual_idea_result_spot"] = float(manual_spot)
        except Exception as error:
            st.session_state.pop("manual_idea_results", None)
            st.error(f"No se pudieron generar las ideas para ese vencimiento: {error}")

    manual_results = st.session_state.get("manual_idea_results") or {}
    if manual_results:
        result_expiration = st.session_state.get("manual_idea_result_expiration", manual_expiration)
        result_spot = float(st.session_state.get("manual_idea_result_spot") or current_spx)
        result_context = st.session_state.get("manual_idea_context") or {}
        st.markdown(
            f"**Resultado LIVE · {selected_symbol()} {result_spot:,.2f} · vencimiento {result_expiration} · "
            f"sesgo {result_context.get('market_bias', 'N/D')}**"
        )
        rendered_any = False
        for strategy_name in ("PCS", "CCS", "Iron Condor"):
            if strategy_name not in manual_results:
                continue
            strategy_ideas = manual_results.get(strategy_name) or []
            st.markdown(f"#### {strategy_name}")
            if not strategy_ideas:
                st.info(
                    f"No encontré una idea de {strategy_name} que cumpla los filtros actuales "
                    f"para {result_expiration}."
                )
                continue
            for position, idea in enumerate(strategy_ideas, start=1):
                rendered_any = True
                with st.container(border=True):
                    head, confidence_column = st.columns([4, 1])
                    if strategy_name == "Iron Condor":
                        structure = (
                            f"PUT {float(idea['short_strike']):,.0f}/{float(idea['long_strike']):,.0f} · "
                            f"CALL {float(idea['secondary_short_strike']):,.0f}/{float(idea['secondary_long_strike']):,.0f}"
                        )
                    else:
                        structure = f"{float(idea['short_strike']):,.0f}/{float(idea['long_strike']):,.0f}"
                    head.markdown(f"**#{position} · {strategy_name} · {structure}**")
                    confidence_column.metric(
                        "Confianza",
                        f"{float(idea.get('confidence') or 0):.0f}%",
                    )
                    one, two, three, four, five = st.columns(5)
                    one.metric("Crédito", f"${float(idea.get('credit') or 0) * 100:,.0f}")
                    two.metric("Riesgo máx.", money(idea.get("max_loss") or 0))
                    three.metric(
                        "Prob. estimada",
                        f"{float(idea.get('estimated_probability') or 0):.1f}%",
                    )
                    four.metric("Score", f"{float(idea.get('score') or 0):.0f}/100")
                    five.metric("DTE", int(idea.get("dte") or 0))
                    details = [
                        f"Delta {float(idea.get('delta') or 0):.3f}",
                        f"Distancia {float(idea.get('distance') or 0):,.1f} pts",
                    ]
                    if idea.get("outside_expected"):
                        details.append("fuera del movimiento esperado")
                    if idea.get("behind_wall"):
                        details.append("protegida por wall")
        ...
        if rendered_any:
            st.caption(
                "La probabilidad mostrada es una estimación basada principalmente en delta y contexto de mercado; "
                "no garantiza el resultado de la operación."
            )

    st.divider()
    st.markdown("### 📚 Historial de ideas")
    ...
    st.markdown(
        f'<div style="display:flex;justify-content:flex-end;margin-bottom:.65rem;">'
        f'<div class="market-pill">{escape(selected_symbol())} <strong>{current_spx:,.2f}</strong> · TRADIER</div>'
        f'</div>',
        unsafe_allow_html=True,
    )
...
elif page == "🤖 Auto Trading SIM":
    render_paper_autotrading_page(selected_symbol())

elif page == "💵 Auto Trading REAL":
    st.title("💵 Auto Trading REAL · Tradier Brokerage")
    st.caption("Cuenta de dinero real · Auto REAL habilitado con reglas de riesgo ultra-conservadoras")

    # Carga las credenciales REAL persistentes del usuario. Si todavía no existe
    # un token REAL separado, reutiliza en memoria el token LIVE ya validado para
    # datos de mercado (Tradier producción usa el mismo entorno).
    current_user = str(st.session_state.get("defender_username") or "").strip().lower()
    loaded_for = str(st.session_state.get("real_credentials_loaded_for") or "")
    if loaded_for != current_user:
        saved_real_token, saved_real_account = load_saved_real_credentials(current_user)
        fallback_live_token = str(st.session_state.get("tradier_live_token") or "").strip()
        st.session_state["tradier_real_token"] = saved_real_token or fallback_live_token
        st.session_state["tradier_real_account_id"] = saved_real_account
        st.session_state["real_credentials_loaded_for"] = current_user

    real_token_default = str(st.session_state.get("tradier_real_token") or "")
    real_account_default = str(st.session_state.get("tradier_real_account_id") or "")

    with st.expander("🔐 Conectar cuenta REAL de Tradier", expanded=not bool(real_token_default and real_account_default)):
        st.warning("Usa únicamente el API token de tu cuenta REAL de Tradier. No uses el token Sandbox en esta sección.")
        real_token_input = st.text_input(
            "Tradier LIVE / REAL API token",
            type="password",
            value="",
            key="tradier_real_token_input",
            placeholder="Pega aquí el token de producción",
        )
        real_account_input = st.text_input(
            "REAL Account ID",
            value=real_account_default,
            key="tradier_real_account_input",
            placeholder="Ej: 6YA00001",
        )
        if st.button("VALIDAR Y GUARDAR CUENTA REAL", use_container_width=True, type="primary"):
            candidate_token = str(real_token_input or real_token_default).strip()
            candidate_account = str(real_account_input or real_account_default).strip()
            try:
                save_real_credentials_for_user(current_user, candidate_token, candidate_account)
                st.session_state["tradier_real_token"] = candidate_token
                st.session_state["tradier_real_account_id"] = candidate_account
                st.success("✅ Cuenta REAL validada directamente con Tradier y guardada para este usuario.")
                st.rerun()
            except Exception as error:
                st.error(f"No se pudo validar la cuenta REAL: {error}")

    real_token, real_account = real_autotrading_credentials()
    connected = bool(real_token and real_account)
    if connected:
        try:
            balances_response = tradier_real_request("GET", f"/accounts/{real_account}/balances", real_token)
            st.success(f"🟢 Tradier REAL conectado · Cuenta ••••{real_account[-4:] if len(real_account) >= 4 else real_account}")
        except Exception as error:
            connected = False
            st.error(f"🔴 La credencial REAL guardada no pudo validarse ahora: {error}")

    a, b, c, d = st.columns(4)
    a.metric("Capital operativo", "$1,000")
    b.metric("Meta diaria", "+$50")
    c.metric("SL máximo/trade", "-$100")
    d.metric("Ancho", "5 puntos")

    e, f, g, h = st.columns(4)
    e.metric("Estrategias", "PCS / CCS")
    f.metric("Score mínimo", "90 / 100")
    g.metric("Delta vendido", "≤ 0.10")
    h.metric("Operaciones simultáneas", "1")

    st.markdown("### 🛡️ Reglas obligatorias de Auto Trading REAL")
    st.markdown(
        """
        - **Solo PCS y CCS inicialmente.** Iron Condor, Iron Butterfly, IC Box y cualquier otra estructura quedan bloqueadas en REAL.
        - **Spread exactamente de 5 puntos.**
        - **Riesgo teórico máximo ≤ $500 por operación**, pero el **Stop Loss operativo máximo es -$100 por trade** y el **Take Profit objetivo es +$50**.
        - **Solo la mejor entrada:** score de calidad **≥ 90/100** y, cuando exista delta válida, **|delta del strike vendido| ≤ 0.10** como filtro conservador de probabilidad estimada.
        - **1 contrato por operación y máximo 2 entradas REAL nuevas por día.** Máximo una posición REAL abierta a la vez; no se permite una entrada nueva hasta que la anterior esté FILLED, VERIFIED y PROTECTED o completamente cerrada. Si un trade pierde -$100, puede buscar otra entrada válida mientras el P/L diario no haya alcanzado -$200.
        - **Límite diario REAL: -$200.** Al alcanzarlo se bloquean nuevas entradas hasta la siguiente sesión. No se aumenta tamaño ni se amplía el SL para recuperar pérdidas.
        - **Preview obligatorio en Tradier** antes de cualquier orden real. Si PREVIEW es válido pero SUBMIT devuelve HTTP 500/timeout, la orden pasa a VERIFYING/UNKNOWN: no se reenvía a ciegas y se bloquean nuevas entradas hasta reconciliar órdenes/posiciones.
        - Noticias de alto impacto: **sin entradas desde 10 minutos antes hasta 10 minutos después**; la gestión de posiciones existentes continúa.
        - Después de una desconexión: **RECONECTAR → SINCRONIZAR → VERIFICAR → PROTEGER → recién entonces permitir una nueva entrada**.
        """
    )

    st.divider()
    s1, s2, s3 = st.columns(3)
    s1.metric("Conexión REAL", "CONECTADA" if connected else "SIN CONECTAR")
    s2.metric("Preview", "OBLIGATORIO")
    s3.metric("Auto REAL", "HABILITADO" if REAL_EXECUTION_ENABLED else "BLOQUEADO")

    if connected:
        st.success(
            "Auto REAL está habilitado para conexión y validación con las reglas duras definidas. "
            "Antes de cualquier envío debe pasar PREVIEW, validación de riesgo, estrategia permitida, score y verificación de estado."
        )
    else:
        st.info("Conecta y valida primero la cuenta REAL. Esto no envía ninguna orden.")

elif page == "🏦 Futuros · MES":
    render_futures_mes_page()

elif page == "🧠 Robot de Portafolio":
    render_portfolio_robot(selected_symbol(), expirations)

if page not in {"🤖 Auto Trading SIM", "💵 Auto Trading REAL"}:
    st.caption("SPX Defender analiza y registra operaciones. Auto Trading SIM usa Sandbox; Auto Trading REAL está habilitado con validaciones de seguridad y reglas conservadoras.")
