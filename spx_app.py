...
""",
    ...
    with right_column:
        ...
        with st.form("tester_login_form", clear_on_submit=False):
            ...
            st.markdown('<div class="secure-note"><strong>🛡 Acceso seguro</strong> &nbsp;·&nbsp; Configuración individual por usuario</div><div class="login-mini-brand">SPX Defender Private Access</div>', unsafe_allow_html=True)
