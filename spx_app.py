...
REAL_TRADING_CAPITAL = 2000.0
REAL_DAILY_PROFIT_TARGET = 50.0
REAL_MAX_RISK_PER_TRADE = 500.0
REAL_SPREAD_WIDTH = 5.0
REAL_ALLOWED_STRATEGIES = {"PCS", "CCS", "Iron Condor"}
...
def process_paper_autotrading(symbol):
    ...
    for signal in signals:
        ...
        try:
            ...
            # En SIM no bloqueamos todas las entradas porque una orden anterior siga pending/verifying.
            # Los conflictos de patas siguen bloqueados más abajo para evitar duplicados exactos.
            ...
            if is_network_error:
                # SIM: un timeout no congela todo el motor. Marcamos ESTA idea para
                # reconciliación y seguimos evaluando ideas distintas. Las mismas patas
                # quedan ocupadas durante este ciclo para impedir un reenvío duplicado.
                try:
...
if page == "📈 Mercado":
    ...
    a, b, c, d = st.columns(4)
    a.metric("Capital operativo", "$2,000")
    b.metric("Meta diaria", "+$50")
    c.metric("Riesgo máximo/trade", "$500")
    d.metric("Ancho", "5 puntos")

    e, f, g, h = st.columns(4)
    e.metric("Estrategias", "PCS / CCS / IC")
    ...
    st.markdown(
        """
        - **Solo PCS, CCS e Iron Condor.** Iron Butterfly, IC Box y cualquier otra estructura quedan bloqueadas en REAL.
        - **Spread exactamente de 5 puntos.**
        - **Riesgo máximo teórico ≤ $500 por operación**, incluyendo cantidad de contratos y crédito recibido.
        ...
        - **1 contrato por operación y máximo 2 entradas REAL nuevas por día.** Máximo una posición REAL abierta a la vez; no se permite una entrada nueva hasta que la anterior esté FILLED, VERIFIED y PROTECTED o completamente cerrada.
        - **Daily Profit Lock:** al alcanzar +$500 de P/L diario combinado, se sigue el máximo del día; si retrocede $200 desde ese máximo, se cierran las posiciones automáticas y se bloquean nuevas entradas hasta la siguiente sesión.
        - **Preview obligatorio en Tradier** antes de cualquier orden real.
